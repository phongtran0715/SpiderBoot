...
public class AddNewSpiderBootAccount extends JDialog {
	 ...
	 * Create the frame.
	 */
	public AddNewSpiderBootAccount() {
		setTitle("Add New Spider Boot Account");
		setIconImage(Toolkit.getDefaultToolkit().getImage(AddNewSpiderBootAccount.class.getResource("/spiderboot/resources/resource/icon_32x32/add_32x32.png")));
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(email.equals(null) || email.equals("")){
					...
					String query = "INSERT INTO spideraccount (	UserName, Password, Email) VALUES (?,?,?)";
		...
		btnOk.setIcon(new ImageIcon(AddNewSpiderBootAccount.class.getResource("/spiderboot/resources/resource/icon_16x16/checked_16x16.png")));
		btnOk.setFont(new Font("Segoe UI", Font.PLAIN, 13));
		btnOk.setBounds(200, 226, 118, 38);
		contentPane.add(btnOk);
		
		JButton btnExit = new JButton("Exit");
		btnExit.setIcon(new ImageIcon(AddNewSpiderBootAccount.class.getResource("/spiderboot/resources/resource/icon_16x16/delete_16x16.png")));
