...
public class ModifySpiderBootAccount extends JDialog {
	 ...
	 * Create the frame.
	 */
	public ModifySpiderBootAccount() {
		initialize();
	}

	public ModifySpiderBootAccount(int id, String userName, String password, String email) {
		initialize();
		this.id = id;
	...
	private void initialize() {
		setTitle("Modify Spider Boot Account");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ModifySpiderBootAccount.class.getResource("/spiderboot/resources/resource/icon_32x32/add_32x32.png")));
		...
		btnOk.setIcon(new ImageIcon(ModifySpiderBootAccount.class.getResource("/spiderboot/resources/resource/icon_16x16/checked_16x16.png")));
		btnOk.setFont(new Font("Segoe UI", Font.PLAIN, 13));
		btnOk.setBounds(200, 226, 118, 38);
		contentPane.add(btnOk);

		JButton btnExit = new JButton("Exit");
		btnExit.setIcon(new ImageIcon(ModifySpiderBootAccount.class.getResource("/spiderboot/resources/resource/icon_16x16/delete_16x16.png")));
