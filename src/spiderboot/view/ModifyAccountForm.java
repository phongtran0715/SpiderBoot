...
public class ModifyAccountForm extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ModifyAccountForm frame = new ModifyAccountForm();
					frame.pack();
	...
	public ModifyAccountForm() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ModifyAccountForm.class.getResource("/spiderboot/resources/resource/icon_32x32/edit_32x32.png")));
		...
		button.setIcon(new ImageIcon(ModifyAccountForm.class.getResource("/spiderboot/resources/resource/icon_16x16/checked_16x16.png")));
		button.setFont(new Font("Segoe UI", Font.PLAIN, 13));
		button.setBounds(269, 297, 118, 38);
		contentPane.add(button);
		
		JButton button_1 = new JButton("Exit");
		button_1.setIcon(new ImageIcon(ModifyAccountForm.class.getResource("/spiderboot/resources/resource/icon_16x16/delete_16x16.png")));
