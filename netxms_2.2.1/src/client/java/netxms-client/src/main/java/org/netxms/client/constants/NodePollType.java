...
public enum NodePollType {
	UNKNOWN(0), STATUS(1), CONFIGURATION_FULL(2), INTERFACES(3), TOPOLOGY(4), CONFIGURATION_NORMAL(
			5), INSTANCE_DISCOVERY(6);
	...
	public static NodePollType getByValue(int value) {
		...
		if (element == null) {
			Logger.warning(NodePollType.class.getName(), "Unknown element "
					+ value);
