...
public enum ReportRenderFormat {
	...
	private static final Map<Integer, ReportRenderFormat> lookupTable = new HashMap<Integer, ReportRenderFormat>(
			2);

	static {
		for (ReportRenderFormat element : EnumSet
				.allOf(ReportRenderFormat.class)) {
