...
public class LinkConfig {
	...
	public LinkConfig(SingleDciConfig[] dciList, List<Long> objectStatusList,
			int color, int routing, long[] bendPoints) {
		super();
	...
	public String toString() {
		return "LinkConfig [dciList=" + Arrays.toString(dciList)
				+ ", objectStatusList=" + objectStatusList.toString()
				+ ", color=" + color + ", routing=" + routing + ", bendPoints="
				+ Arrays.toString(bendPoints) + "]";
	}
}
