...
public abstract class DciValue {
	 ...
	 */
	public static DciValue createFromMessage(long nodeId, NXCPMessage msg,
			long base) {
	 ...
	 *            NXCP message
	 * @param base
	 *            Base field ID for value object
	 */
	...
	/**
	 * Returns formated DCI value or string with format error and correct type
	 * of DCI value;
	 * 
	 * @param formatString
	 *            the string into which will be placed DCI value
	 * @return The format
	 */
	 ...
	 * 
	 * @return severity of active threshold or NORMAL if there are no active
	 *         thresholds
	 */
	public Severity getThresholdSeverity() {
		return (activeThreshold != null) ? activeThreshold.getCurrentSeverity()
				: Severity.NORMAL;
	}
}
