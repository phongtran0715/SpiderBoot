...
public abstract class MessageHandler {
	...
	/**
	 * Set handler to complete state. This will signal all waiters and remove
	 * subscription.
	 */
	 ...
	 *            the lastMessageTimestamp to set
	 */
	...
	/**
	 * @param messageWaitTimeout
	 *            the messageWaitTimeout to set
	 */
	...
	/**
	 * Process message. If handler returns true message will not be placed into
	 * waiting queue.
	 * 
	 * @param msg
	 *            NXCP message to process
