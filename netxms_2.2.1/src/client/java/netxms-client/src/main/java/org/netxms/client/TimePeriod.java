...
public class TimePeriod {
	...
	public TimePeriod(int timeFrameType, int timeRangeValue, int timeUnitValue,
			Date timeFromValue, Date timeToValue) {
	...
	public Date getPeriodStart() {
		if (isBackFromNow()) {
			...
			case GraphSettings.TIME_UNIT_MINUTE:
				return new Date((new Date()).getTime() - (long) timeRangeValue
						* 60L * 1000L);
