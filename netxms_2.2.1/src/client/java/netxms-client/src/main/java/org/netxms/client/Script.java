...
public class Script {
	...
	public Script(NXCPMessage msg) {
		...
		this.name = msg.getFieldAsString(NXCPCodes.VID_NAME).equals("") ? ("["
				+ Long.toString(id) + "]") : msg
				.getFieldAsString(NXCPCodes.VID_NAME);
	...
	public Script(NXCPMessage msg, long base) {
		...
		this.name = msg.getFieldAsString(base).equals("") ? ("["
				+ Long.toString(id) + "]") : msg.getFieldAsString(base);
		base++;
		this.source = null;
	}
