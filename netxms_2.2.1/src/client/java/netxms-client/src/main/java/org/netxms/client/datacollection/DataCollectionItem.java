...
public class DataCollectionItem extends DataCollectionObject {
	 ...
	 *            NXCP message
	 */
	protected DataCollectionItem(final DataCollectionConfiguration owner,
			final NXCPMessage msg) {
		super(owner, msg);

		dataType = msg.getFieldAsInt32(NXCPCodes.VID_DCI_DATA_TYPE);
		deltaCalculation = msg
				.getFieldAsInt32(NXCPCodes.VID_DCI_DELTA_CALCULATION);
		...
		snmpRawValueType = msg
				.getFieldAsInt32(NXCPCodes.VID_SNMP_RAW_VALUE_TYPE);
