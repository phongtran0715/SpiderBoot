...
public enum LinkLayerDiscoveryProtocol {
	...
	public static LinkLayerDiscoveryProtocol getByValue(int value) {
		...
		if (element == null) {
			Logger.warning(LinkLayerDiscoveryProtocol.class.getName(),
