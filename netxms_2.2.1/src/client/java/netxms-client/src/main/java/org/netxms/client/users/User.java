...
public class User extends AbstractUserObject {
	...
	public User(final NXCPMessage msg) {
		...
		certMappingMethod = msg
				.getFieldAsInt32(NXCPCodes.VID_CERT_MAPPING_METHOD);
		...
		lastPasswordChange = msg
				.getFieldAsDate(NXCPCodes.VID_LAST_PASSWORD_CHANGE);
		minPasswordLength = msg
				.getFieldAsInt32(NXCPCodes.VID_MIN_PASSWORD_LENGTH);
	...
	public void fillMessage(final NXCPMessage msg) {
		...
		msg.setFieldInt32(
				NXCPCodes.VID_DISABLED_UNTIL,
				(disabledUntil != null) ? (int) (disabledUntil.getTime() / 1000)
						: 0);
