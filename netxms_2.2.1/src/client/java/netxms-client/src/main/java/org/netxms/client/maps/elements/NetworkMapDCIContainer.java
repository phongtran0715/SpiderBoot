...
public class NetworkMapDCIContainer extends NetworkMapElement {
	...
	protected NetworkMapDCIContainer(NXCPMessage msg, long baseId) {
		...
		try {
			DciContainerConfiguration conf = DciContainerConfiguration
					.createFromXml(DCIListXml);
	 ...
	 * 
	 * @see
	 * org.netxms.client.maps.elements.NetworkMapElement#fillMessage(org.netxms
	 * .base.NXCPMessage, long)
	 */
	@Override
	...
	/**
	 * @param borderRequired
	 *            the borderRequired to set
	 */
