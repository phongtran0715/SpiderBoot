...
public class AgentTunnel {
	...
	public String toString() {
		return "AgentTunnel [id=" + id + ", guid=" + guid + ", address="
				+ address + ", nodeId=" + nodeId + ", systemName=" + systemName
				+ ", systemInformation=" + systemInformation
				+ ", platformName=" + platformName + ", agentVersion="
				+ agentVersion + ", zoneUIN=" + zoneUIN
