...
public class ScheduledTask {
	...
	final static private String statusDescription[] = { "Disabled",
			"Completed", "Running" };
	...
	public ScheduledTask(String scheduledTaskId, String schedule,
			String parameters, String comments, Date executionTime, int flags,
			long objectId) {
		id = 0;
