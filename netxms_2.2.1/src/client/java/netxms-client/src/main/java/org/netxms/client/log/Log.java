...
public class Log {
	 ...
	 *            Client session
	 * @param msg
	 *            NXCP message with server's reply
	 */
	 ...
	 * @param columnName
	 *            Column name
	 * @return Column description or null if column with given name does not
	 *         exist
	 */
	...
	/**
	 * Retrieve log data from server. You must first call query() to prepare
	 * data on server.
	 * 
	 * @param startRow
	 *            start row to retrieve
	 * @param rowCount
	 ...
	 * @throws NXCException
	 */
	public Table retrieveData(long startRow, long rowCount) throws IOException,
			NXCException {
	 ...
	 *            number of rows to retrieve
	 * @param refresh
	 *            if set to true, server will reload data from database instead
	 *            of using cache
	 * @return data set
	 * @throws IOException
	 * @throws NXCException
	 */
	public Table retrieveData(long startRow, long rowCount, boolean refresh)
