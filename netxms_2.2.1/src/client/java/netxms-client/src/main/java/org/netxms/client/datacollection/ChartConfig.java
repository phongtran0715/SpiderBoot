...
public class ChartConfig {
	...
	private Set<GraphSettingsChangeListener> changeListeners = new HashSet<GraphSettingsChangeListener>(
			0);
	...
	public TimePeriod timePeriod() {
		return new TimePeriod(timeFrameType, timeRange, timeUnits, timeFrom,
				timeTo);
	}

	/**
	 * @param tp
	 *            The time period to set
	 */
