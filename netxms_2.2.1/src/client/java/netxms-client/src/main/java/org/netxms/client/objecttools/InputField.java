...
public class InputField {
	 ...
	 * @param config
	 */
	public InputField(String name, InputFieldType type, String displayName,
			String config) {
		this.name = name;
		this.type = type;
	...
	protected InputField(NXCPMessage msg, long baseId) {
		...
		options = InputFieldOptions.createFromXml(msg
				.getFieldAsString(baseId + 3));
	...
	public String toString() {
		return "InputField [name=" + name + ", type=" + type + ", displayName="
				+ displayName + "]";
	}
}
