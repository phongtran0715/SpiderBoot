...
public class DefaultGalleryGroupRenderer extends AbstractGridGroupRenderer {
	...
	protected Rectangle getToggleButtonBounds() {
		return new Rectangle(minMargin
				+ RendererHelper.getShift(titleHeight, 9),
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.netxms.nebula.widgets.gallery.AbstractGridGroupRenderer#draw(org
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.netxms.nebula.widgets.gallery.AbstractGridGroupRenderer#getItem(
	 * org.netxms.nebula.widgets.gallery.GalleryItem,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.netxms.nebula.widgets.gallery.AbstractGridGroupRenderer#getSize(
	 * org.netxms.nebula.widgets.gallery.GalleryItem)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.netxms.nebula.widgets.gallery.AbstractGridGroupRenderer#drawItem
