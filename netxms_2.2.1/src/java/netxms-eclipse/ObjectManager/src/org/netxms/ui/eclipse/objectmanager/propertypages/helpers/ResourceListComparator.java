...
public class ResourceListComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object e1, Object e2) {
		...
		case ClusterResources.COLUMN_NAME:
			result = ((ClusterResource) e1).getName().compareToIgnoreCase(
					((ClusterResource) e2).getName());
			break;
		case ClusterResources.COLUMN_IP_ADDRESS:
			byte[] addr1 = ((ClusterResource) e1).getVirtualAddress()
					.getAddress();
			byte[] addr2 = ((ClusterResource) e2).getVirtualAddress()
					.getAddress();
