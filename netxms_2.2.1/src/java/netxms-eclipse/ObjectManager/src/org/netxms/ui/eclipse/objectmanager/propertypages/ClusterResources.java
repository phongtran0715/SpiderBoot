...
public class ClusterResources extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		final String[] columnNames = { Messages.get().ClusterResources_ColName,
				Messages.get().ClusterResources_ColVIP };
	...
	private void addResource() {
		EditClusterResourceDialog dlg = new EditClusterResourceDialog(
				getShell(), null);
		if (dlg.open() == Window.OK) {
			...
			ClusterResource r = new ClusterResource(id, dlg.getName(),
					dlg.getAddress());
			resources.add(r);
			viewer.setInput(resources.toArray());
	...
	protected void applyChanges(final boolean isApply) {
		...
		new ConsoleJob(Messages.get().ClusterResources_JobName, null,
