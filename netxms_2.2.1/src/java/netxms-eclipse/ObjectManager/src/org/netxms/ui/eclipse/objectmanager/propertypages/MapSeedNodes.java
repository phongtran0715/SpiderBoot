...
public class MapSeedNodes extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		seedNodes = new HashSet<AbstractObject>(session.findMultipleObjects(
				((NetworkMap) object).getSeedObjectIds(), false));
		...
		addButton.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				final ObjectSelectionDialog dlg = new ObjectSelectionDialog(
	...
	protected void applyChanges(final boolean isApply) {
		...
		new ConsoleJob("Update network map seed nodes", null,
