...
public abstract class MultipleObjectAction implements IObjectActionDelegate {
	 ...
	 */
	abstract protected String formatErrorMessage(AbstractObject object,
			Display display);
	 ...
	 * @throws Exception
	 */
	abstract protected void runObjectAction(final NXCSession session,
			final AbstractObject object) throws Exception;

	/**
	 * Hook for possible confirmation. Default implementation always returns
	 * true.
	 * 
	...
	public final void run(IAction action) {
		...
		while (it.hasNext()) {
			...
			final NXCSession session = (NXCSession) ConsoleSharedData
					.getSession();
			new ConsoleJob(formatJobDescription(object), part,
