	...
	public void run(IAction action) {
		...
		do {
			...
			final NXCObjectCreationData cd = new NXCObjectCreationData(
					AbstractObject.OBJECT_NODE, dlg.getObjectName(), parentId);
			...
			final NXCSession session = (NXCSession) ConsoleSharedData
					.getSession();
			new ConsoleJob(Messages.get().CreateNode_JobTitle, part,
				...
				protected String getErrorMessage() {
					return String.format(Messages.get().CreateNode_JobError,
							cd.getName());
				}
			}.start();
