...
public class CreateZone implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		new ConsoleJob(Messages.get().CreateZone_JobTitle, part,
			...
			protected void runInternal(IProgressMonitor monitor)
				...
				NXCObjectCreationData cd = new NXCObjectCreationData(
						AbstractObject.OBJECT_ZONE, dlg.getName(), parentId);
			...
			protected String getErrorMessage() {
				return String.format(Messages.get().CreateZone_JobError,
						dlg.getName());
			}
		}.start();
	}
