...
public class RackProperties extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		gd.grabExcessHorizontalSpace = true;
		gd.horizontalAlignment = SWT.FILL;
		numberingScheme = WidgetHelper.createLabeledCombo(dialogArea,
				SWT.READ_ONLY | SWT.DROP_DOWN,
				Messages.get().RackProperties_Numbering, gd);
	...
	protected void applyChanges(final boolean isApply) {
		...
		new ConsoleJob(String.format(
				Messages.get().RackProperties_UpdatingRackProperties,
				rack.getObjectName()), null, Activator.PLUGIN_ID, null) {
			@Override
