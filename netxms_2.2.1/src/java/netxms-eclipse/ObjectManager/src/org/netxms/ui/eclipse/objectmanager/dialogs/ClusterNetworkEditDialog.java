...
public class ClusterNetworkEditDialog extends Dialog {
	 ...
	 * @param parentShell
	 */
	public ClusterNetworkEditDialog(Shell parentShell, InetAddress address,
			InetAddress mask) {
		super(parentShell);
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText((address == null) ? Messages.get().ClusterNetworkEditDialog_AddNet
				: Messages.get().ClusterNetworkEditDialog_ModifyNet);
	}
	...
	protected void okPressed() {
		try {
			...
			MessageDialogHelper.openWarning(getShell(),
					Messages.get().ClusterNetworkEditDialog_Warning,
					Messages.get().ClusterNetworkEditDialog_WarningInvalidIP);
			return;
		}
		super.okPressed();
	}
