...
public class ClusterNetworks extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		final String[] columnNames = {
				Messages.get().ClusterNetworks_ColAddress,
				Messages.get().ClusterNetworks_ColMask };
	...
	private void addNetwork() {
		ClusterNetworkEditDialog dlg = new ClusterNetworkEditDialog(getShell(),
				null, null);
	...
	protected void applyChanges(final boolean isApply) {
		...
		new ConsoleJob(Messages.get().ClusterNetworks_JobName, null,
