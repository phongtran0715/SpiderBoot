...
public class EditClusterResourceDialog extends Dialog {
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText((resource != null) ? Messages.get().EditClusterResourceDialog_TitleEdit
				: Messages.get().EditClusterResourceDialog_TitleCreate);
	}
	...
	protected void okPressed() {
		try {
			...
			MessageDialogHelper.openWarning(getShell(),
					Messages.get().EditClusterResourceDialog_Warning,
					Messages.get().EditClusterResourceDialog_WarningInvalidIP);
			return;
		}
		...
		if (name.isEmpty()) {
			MessageDialogHelper.openWarning(getShell(),
					Messages.get().EditClusterResourceDialog_Warning,
					Messages.get().EditClusterResourceDialog_WarningEmptyName);
			return;
		}
