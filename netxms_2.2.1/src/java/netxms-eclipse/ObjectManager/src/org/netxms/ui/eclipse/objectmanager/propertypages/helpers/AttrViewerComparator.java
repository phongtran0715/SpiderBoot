...
public class AttrViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object e1, Object e2) {
		...
		case CustomAttributes.COLUMN_NAME:
			rc = ((Entry<String, String>) e1).getKey().compareToIgnoreCase(
					((Entry<String, String>) e2).getKey());
			break;
		case CustomAttributes.COLUMN_VALUE:
			rc = ((Entry<String, String>) e1).getValue().compareToIgnoreCase(
					((Entry<String, String>) e2).getValue());
			break;
		default:
			rc = 0;
			break;
