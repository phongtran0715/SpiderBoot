...
public class ChangeZone implements IObjectActionDelegate {
	 ...
	 */
	public ChangeZone() {
		zoningEnabled = ((NXCSession) ConsoleSharedData.getSession())
				.isZoningEnabled();
	}
	...
	public void run(IAction action) {
		final ZoneSelectionDialog dlg = new ZoneSelectionDialog(
				window.getShell());
		if (dlg.open() != Window.OK)
			return;

		final NXCSession session = (NXCSession) ConsoleSharedData.getSession();
		new ConsoleJob(String.format(Messages.get().ChangeZone_JobTitle,
				node.getObjectName(), node.getObjectId()), part,
			...
			protected String getErrorMessage() {
				return String.format(Messages.get().ChangeZone_JobError,
