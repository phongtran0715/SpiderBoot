...
public class ZoneCommunications extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		agentProxy.setClassFilter(ObjectSelectionFilterFactory.getInstance()
	...
	protected boolean applyChanges(final boolean isApply) {
		...
		new ConsoleJob(String.format(Messages.get().ZoneCommunications_JobName,
				zone.getObjectName()), null, Activator.PLUGIN_ID, null) {
			@Override
