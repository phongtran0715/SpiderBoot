...
public class ConditionEvents extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		activationEvent
				.setLabel(Messages.get().ConditionEvents_ActivationEvent);
		...
		deactivationEvent
				.setLabel(Messages.get().ConditionEvents_DeactivationEvent);
		...
		sourceObject
				.setEmptySelectionName(Messages.get().ConditionEvents_SelectionServer);
		...
		activeStatus = new StatusSelector(statusGroup, SWT.NONE,
				Severity.CRITICAL.getValue());
		...
		inactiveStatus = new StatusSelector(statusGroup, SWT.NONE,
				Severity.CRITICAL.getValue());
	...
	protected void applyChanges(final boolean isApply) {
		...
		new ConsoleJob(Messages.get().ConditionEvents_JobName, null,
