...
public class ConditionDciEditDialog extends Dialog {
	 ...
	 * @param dciName
	 */
	public ConditionDciEditDialog(Shell parentShell, ConditionDciInfo dci,
			String nodeName, String dciName) {
		super(parentShell);
		this.dci = dci;
	...
	protected Control createDialogArea(Composite parent) {
		...
		LabeledText node = new LabeledText(dialogArea, SWT.NONE, SWT.BORDER
				| SWT.READ_ONLY);
		...
		LabeledText parameter = new LabeledText(dialogArea, SWT.NONE,
		...
		if (dci.getType() != DataCollectionObject.DCO_TYPE_TABLE) {
			...
			gd.horizontalAlignment = SWT.FILL;
			gd.grabExcessHorizontalSpace = true;
			function = WidgetHelper.createLabeledCombo(dialogArea, SWT.NONE,
					Messages.get().ConditionDciEditDialog_Function, gd);
			...
			polls = (Spinner) WidgetHelper.createLabeledControl(dialogArea,
					SWT.BORDER, factory,
					Messages.get().ConditionDciEditDialog_Polls, gd);
