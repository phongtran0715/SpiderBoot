...
public class ObjectSelector extends AbstractSelector {
	...
	public void setObjectId(long objectId) {
		...
		if (objectId == 0) {
			...
			final AbstractObject object = ((NXCSession) ConsoleSharedData
					.getSession()).findObjectById(objectId);
			setText((object != null) ? object.getObjectName()
					: ("<" + Long.toString(objectId) + ">")); //$NON-NLS-1$ //$NON-NLS-2$
		}
	}
