...
public class ObjectSearchResultComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object e1, Object e2) {
		...
		case ObjectFinder.COL_IP_ADDRESS:
			...
			result = ComparatorHelper.compareInetAddresses(a1.getAddress(),
					a2.getAddress());
			break;
		case ObjectFinder.COL_NAME:
			result = object1.getObjectName().compareToIgnoreCase(
					object2.getObjectName());
			break;
		case ObjectFinder.COL_CLASS:
		case ObjectFinder.COL_PARENT:
		case ObjectFinder.COL_ZONE:
			String t1 = ((ITableLabelProvider) ((SortableTableViewer) viewer)
					.getLabelProvider()).getColumnText(object1, column);
			String t2 = ((ITableLabelProvider) ((SortableTableViewer) viewer)
					.getLabelProvider()).getColumnText(object2, column);
