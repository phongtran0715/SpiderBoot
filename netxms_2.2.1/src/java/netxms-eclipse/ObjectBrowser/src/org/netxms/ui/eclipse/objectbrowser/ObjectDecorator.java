 ...
 */
public class ObjectDecorator extends BaseLabelProvider implements
	...
	public ObjectDecorator() {
		...
		statusImages[1] = Activator
				.getImageDescriptor("icons/status/warning.png"); //$NON-NLS-1$
		statusImages[2] = Activator
				.getImageDescriptor("icons/status/minor.png"); //$NON-NLS-1$
		statusImages[3] = Activator
				.getImageDescriptor("icons/status/major.png"); //$NON-NLS-1$
		statusImages[4] = Activator
				.getImageDescriptor("icons/status/critical.png"); //$NON-NLS-1$
		statusImages[5] = Activator
				.getImageDescriptor("icons/status/unknown.gif"); //$NON-NLS-1$
		statusImages[6] = Activator
				.getImageDescriptor("icons/status/unmanaged.gif"); //$NON-NLS-1$
		statusImages[7] = Activator
				.getImageDescriptor("icons/status/disabled.gif"); //$NON-NLS-1$
		statusImages[8] = Activator
		...
		if (element instanceof Interface) {
			if ((((Interface) element).getOperState() == Interface.OPER_STATE_DOWN)
				...
				decoration.addOverlay(
						statusImages[ObjectStatus.CRITICAL.getValue()],
