...
public class ObjectSelectionFilterFactory {
	...
	public static ObjectSelectionFilterFactory getInstance() {
		if (instance == null) {
			...
			for (int i = 0; i < elements.length; i++) {
				try {
					instance = (ObjectSelectionFilterFactory) elements[i]
			...
			if (instance == null)
				instance = new ObjectSelectionFilterFactory(); // use default
																// implementation
		}
		return instance;
	}
	 ...
	 * @return Class filter for node selection
	 */
	public Set<Integer> createNodeAndTemplateSelectionFilter(
