	...
	public ObjectTreeViewer(Composite parent, int style) {
		...
		setComparer(new IElementComparer() {
			...
			public int hashCode(Object element) {
				return (element instanceof AbstractObject) ? (int) ((AbstractObject) element)
						.getObjectId() : element.hashCode();
			}

			@Override
			public boolean equals(Object a, Object b) {
				if ((a instanceof AbstractObject)
						&& (b instanceof AbstractObject))
					return ((AbstractObject) a).getObjectId() == ((AbstractObject) b)
							.getObjectId();
				return a.equals(b);
			}
		});
