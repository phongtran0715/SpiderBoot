...
public class ObjectConditionEditor extends ConditionEditor {
	private static final String[] OPERATIONS = {
			Messages.get().ObjectConditionEditor_Is,
			Messages.get().ObjectConditionEditor_IsNot,
			Messages.get().ObjectConditionEditor_Within,
			Messages.get().ObjectConditionEditor_NotWithin };
	...
	public ColumnFilter createFilter() {
		...
		ColumnFilter filter = new ColumnFilter(
				((op == 2) || (op == 3)) ? ColumnFilterType.CHILDOF
						: ColumnFilterType.EQUALS, objectId);
