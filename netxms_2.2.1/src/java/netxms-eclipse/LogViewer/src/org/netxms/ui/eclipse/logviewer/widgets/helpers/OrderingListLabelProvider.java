...
public class OrderingListLabelProvider implements ITableLabelProvider {
	...
	public Image getColumnImage(Object element, int columnIndex) {
		if (columnIndex == 1)
			return ((OrderingColumn) element).isDescending() ? SharedIcons.IMG_CHECKBOX_ON
					: SharedIcons.IMG_CHECKBOX_OFF;
		return null;
	}
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case 1:
			return ((OrderingColumn) element).isDescending() ? Messages.get().OrderingListLabelProvider_Yes
					: Messages.get().OrderingListLabelProvider_No;
		default:
			return null;
		}
	}
