...
public class SnmpTrapFilter extends ViewerFilter {
	...
	public boolean descriptionMatch(Object element) {
		if (((SnmpTrap) element).getDescription().toLowerCase()
	...
	public boolean eventMatch(Object element) {
		...
		if (session
				.findEventTemplateByCode(((SnmpTrap) element).getEventCode())
				.toString().toLowerCase().contains(filterString))
			return true;
		return false;
	}
	...
	public boolean objectIdMatch(Object element) {
		if (((SnmpTrap) element).getObjectId().toString().toLowerCase()
				.contains(filterString))
			return true;
		return false;
	}
