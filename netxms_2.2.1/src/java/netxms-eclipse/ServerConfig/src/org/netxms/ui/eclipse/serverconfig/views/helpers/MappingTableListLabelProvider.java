 ...
 */
public class MappingTableListLabelProvider extends LabelProvider implements
		ITableLabelProvider {
	/*
	 * (non-Javadoc)
	 * 
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case MappingTables.COLUMN_FLAGS:
			return ((d.getFlags() & MappingTable.NUMERIC_KEYS) != 0) ? Messages
					.get().MappingTableListLabelProvider_FlagNumeric : Messages
					.get().MappingTableListLabelProvider_FlagNone;
		}
		return null;
	}
}
