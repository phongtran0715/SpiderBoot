...
public class SelectSnmpTrapDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		final String[] names = { Messages.get().SelectSnmpTrapDialog_ColOID,
				Messages.get().SelectSnmpTrapDialog_ColEvent,
				Messages.get().SelectSnmpTrapDialog_ColDescription };
		final int[] widths = { 350, 250, 400 };
		viewer = new SortableTableViewer(dialogArea, names, widths, COLUMN_OID,
				SWT.UP, SWT.FULL_SELECTION | SWT.MULTI | SWT.BORDER);
