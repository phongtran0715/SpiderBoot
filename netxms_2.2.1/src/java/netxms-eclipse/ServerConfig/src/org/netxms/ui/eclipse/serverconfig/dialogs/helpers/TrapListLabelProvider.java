 ...
 */
public class TrapListLabelProvider extends LabelProvider implements
		ITableLabelProvider {
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case SelectSnmpTrapDialog.COLUMN_EVENT:
			EventTemplate evt = session.findEventTemplateByCode(trap
					.getEventCode());
			return (evt != null) ? evt.getName()
					: ("[" + Integer.toString(trap.getEventCode()) + "]"); //$NON-NLS-1$ //$NON-NLS-2$
