...
public class ConfigurationImportDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		textFileName = WidgetHelper.createLabeledText(dialogArea, SWT.BORDER,
				300, Messages.get().ConfigurationImportDialog_FileName, null,
		...
		overrideEventsByName
				.setText(Messages.get().ConfigurationImportDialog_ReplaceByName);

		overrideEventsByCode = new Button(options, SWT.CHECK);
		overrideEventsByCode
				.setText(Messages.get().ConfigurationImportDialog_ReplaceByCode);
