...
public class SummaryTable extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		viewer = new SummaryTableWidget(parent, SWT.NONE, this, tableId,
				baseObjectId);
	...
	public void setTable(Table table) {
		...
		setPartName(table.getTitle()
				+ " - " + ((object != null) ? object.getObjectName() : ("[" + baseObjectId + "]"))); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		viewer.update(table);
	}
}
