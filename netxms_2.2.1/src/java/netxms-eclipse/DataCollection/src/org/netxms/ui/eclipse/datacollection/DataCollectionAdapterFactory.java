...
public class DataCollectionAdapterFactory implements IAdapterFactory {
	...
	private static final String[] dciStatusImages = {
			"icons/active.gif", "icons/disabled.gif", "icons/unsupported.gif" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		if (adapterType == IWorkbenchAdapter.class) {
			return new IWorkbenchAdapter() {
				...
				public ImageDescriptor getImageDescriptor(Object object) {
					return Activator
							.getImageDescriptor(dciStatusImages[((DataCollectionObject) object)
									.getStatus()]);
				}
			...
			DataCollectionObjectEditor e = (DataCollectionObjectEditor) ((DataCollectionObject) adaptableObject)
					.getUserData();
			if (e == null) {
				e = new DataCollectionObjectEditor(
						(DataCollectionObject) adaptableObject);
