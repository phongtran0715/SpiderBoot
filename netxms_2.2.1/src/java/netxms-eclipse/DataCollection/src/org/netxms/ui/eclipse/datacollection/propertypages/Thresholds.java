...
public class Thresholds extends DCIPropertyPageDialog {
	...
	protected Control createContents(Composite parent) {
		...
		if (dci.getTemplateId() == dci.getNodeId()) // DCI created by instance
													// discovery
		...
		new Label(thresholdArea, SWT.NONE)
				.setText(Messages.get().Thresholds_Thresholds);

		thresholdList = new TableViewer(thresholdArea, SWT.BORDER | SWT.MULTI
				...
				.addSelectionChangedListener(new ISelectionChangedListener() {
					...
					public void selectionChanged(SelectionChangedEvent event) {
						IStructuredSelection selection = (IStructuredSelection) event
								.getSelection();
						int index = thresholds.indexOf(selection
								.getFirstElement());
	...
	private void editThreshold() {
		...
		if (selection.size() == 1) {
			...
			EditThresholdDialog dlg = new EditThresholdDialog(getShell(),
					threshold);
