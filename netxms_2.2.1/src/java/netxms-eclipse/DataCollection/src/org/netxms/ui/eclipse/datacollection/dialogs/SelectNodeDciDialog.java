...
public class SelectNodeDciDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		dciList = new DciList(null, dialogArea, SWT.BORDER, null,
				"SelectNodeDciDialog.dciList", dcObjectType, SWT.SINGLE, false); //$NON-NLS-1$
	...
	protected void okPressed() {
		...
		if (selection == null || selection.size() == 0) {
			MessageDialogHelper.openWarning(getShell(),
					Messages.get().SelectNodeDciDialog_Warning,
					Messages.get().SelectNodeDciDialog_WarningText);
			return;
		}
		saveSettings();
		super.okPressed();
