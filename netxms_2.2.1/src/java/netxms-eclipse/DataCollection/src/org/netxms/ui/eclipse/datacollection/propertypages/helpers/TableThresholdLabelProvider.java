 ...
 */
public class TableThresholdLabelProvider extends LabelProvider implements
		ITableLabelProvider {
	...
	public Image getColumnImage(Object element, int columnIndex) {
		...
		case 2: {
			final EventTemplate event = session
					.findEventTemplateByCode(((TableThreshold) element)
							.getActivationEvent());
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case 1:
			return Integer
					.toString(((TableThreshold) element).getSampleCount());
		case 2: {
			final EventTemplate event = session
					.findEventTemplateByCode(((TableThreshold) element)
							.getActivationEvent());
