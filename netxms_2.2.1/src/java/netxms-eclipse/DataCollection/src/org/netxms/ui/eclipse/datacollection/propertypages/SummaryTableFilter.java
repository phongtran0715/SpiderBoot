...
public class SummaryTableFilter extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		filter = (ScriptEditor) WidgetHelper.createLabeledControl(dialogArea,
				SWT.BORDER, factory,
				Messages.get().SummaryTableFilter_FilterScript, gd);
		gd = new GridData();
		gd.horizontalAlignment = SWT.FILL;
		gd.verticalAlignment = SWT.FILL;
		gd.grabExcessHorizontalSpace = true;
	...
	protected void applyChanges(final boolean isApply) {
		...
		new ConsoleJob(Messages.get().SummaryTableFilter_JobName, null,
