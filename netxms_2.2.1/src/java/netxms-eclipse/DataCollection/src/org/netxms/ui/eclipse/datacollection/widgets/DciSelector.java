...
public class DciSelector extends AbstractSelector {
	...
	private void updateText() {
		...
		new ConsoleJob(Messages.get().DciSelector_JobTitle, null,
				Activator.PLUGIN_ID, null) {
			@Override
			protected void runInternal(IProgressMonitor monitor)
					throws Exception {
				final String[] names = session.dciIdsToNames(
						new long[] { nodeId },
						new long[] { DciSelector.this.dciId });
	...
	/**
	 * @param emptySelectionName
	 *            the emptySelectionName to set
	 */
