...
public class SelectSummaryTableDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		new Label(dialogArea, SWT.NONE)
				.setText(Messages.get().SelectSummaryTableDialog_Label);
	...
	protected void okPressed() {
		...
		if (selection.size() == 0) {
			MessageDialogHelper
					.openWarning(
							getShell(),
							Messages.get().SelectSummaryTableDialog_Warning,
							Messages.get().SelectSummaryTableDialog_EmptySelectionWarning);
			return;
		}
