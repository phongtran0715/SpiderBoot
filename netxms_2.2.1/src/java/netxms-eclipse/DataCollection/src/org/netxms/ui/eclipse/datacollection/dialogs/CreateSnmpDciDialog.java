...
public class CreateSnmpDciDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		textDescription
				.setLabel(Messages.get().CreateSnmpDciDialog_Description);
		...
		deltaCalculationSelector = WidgetHelper.createLabeledCombo(
				optionsGroup, SWT.BORDER | SWT.READ_ONLY,
				Messages.get().CreateSnmpDciDialog_DeltaCalculation,
		...
		deltaCalculationSelector
				.add(Messages.get().Transformation_DeltaAvgPerSec);
		deltaCalculationSelector
				.add(Messages.get().Transformation_DeltaAvgPerMin);
