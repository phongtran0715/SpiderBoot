...
/**
 * Label provider for visibility table. Uses default workbench label provider
 * for user object and implements own for String like with warning.
 */
public class AccessListLabelProvider extends LabelProvider implements
		IColorProvider {
	private static final Color HINT_FOREGROUND = new Color(
			Display.getDefault(), 192, 192, 192);
