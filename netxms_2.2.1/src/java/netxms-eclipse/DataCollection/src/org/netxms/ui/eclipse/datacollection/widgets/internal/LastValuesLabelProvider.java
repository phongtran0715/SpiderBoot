 ...
 */
public class LastValuesLabelProvider extends LabelProvider implements
	...
	public Image getColumnImage(Object element, int columnIndex) {
		...
		case LastValuesWidget.COLUMN_THRESHOLD:
			...
			return (threshold != null) ? thresholdLabelProvider.getColumnImage(
					threshold, Thresholds.COLUMN_EVENT) : StatusDisplayInfo
					.getStatusImage(Severity.NORMAL);
		}
		return null;
	}
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case LastValuesWidget.COLUMN_VALUE:
			...
			return useMultipliers ? ((DciValue) element).format("%*s")
					: ((DciValue) element).getValue();
	...
	private String formatThreshold(Threshold threshold) {
		...
		return thresholdLabelProvider.getColumnText(threshold,
