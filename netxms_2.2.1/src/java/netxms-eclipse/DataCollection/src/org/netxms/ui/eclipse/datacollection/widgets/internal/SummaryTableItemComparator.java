...
public class SummaryTableItemComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object e1, Object e2) {
		final int column = (Integer) ((SortableTreeViewer) viewer).getTree()
				.getSortColumn().getData("ID"); //$NON-NLS-1$
		final int format = (column < formats.length) ? formats[column]
				: DataCollectionItem.DT_STRING;
		...
		case DataCollectionItem.DT_FLOAT:
			result = (int) Math.signum(safeParseDouble(value1)
					- safeParseDouble(value2));
			break;
		default:
