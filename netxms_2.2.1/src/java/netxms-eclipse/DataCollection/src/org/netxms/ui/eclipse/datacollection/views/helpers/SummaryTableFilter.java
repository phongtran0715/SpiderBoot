...
public class SummaryTableFilter extends ViewerFilter {
	...
	public boolean checkId(Object element) {
		if (Integer.toString(((DciSummaryTableDescriptor) element).getId())
	...
	public boolean checkPath(Object element) {
		if (((DciSummaryTableDescriptor) element).getMenuPath().toLowerCase()
	...
	public boolean checkTitle(Object element) {
		if (((DciSummaryTableDescriptor) element).getTitle().toLowerCase()
				.contains(filterString))
			return true;
		return false;
	}
