...
public class DCIPropertyPageDialog extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		String message = DataCollectionObjectEditor
				.createModificationWarningMessage(editor.getObject());
		if (message != null) {
			Composite messageArea = new Composite(parent, SWT.BORDER);
			messageArea.setBackground(SharedColors.getColor(
					SharedColors.MESSAGE_BAR_BACKGROUND,
					messageArea.getDisplay()));
			...
			imageLabel.setImage(Activator.getImageDescriptor(
					"icons/warning.png").createImage());
			gd = new GridData();
			...
			messageLabel.setForeground(SharedColors.getColor(
					SharedColors.MESSAGE_BAR_TEXT, messageArea.getDisplay()));
