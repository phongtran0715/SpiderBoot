...
public interface DataCollectionObjectListener {
	/**
	 * Called by editor after user choose new single value parameter using
	 * "Select" button
	 * 
	 * @param origin
	 * @param name
	 ...
	 * @param dataType
	 */
	public void onSelectItem(int origin, String name, String description,
			int dataType);

	/**
	 * Called by editor after user choose new table parameter using "Select"
	 * button
	 * 
	 * @param origin
	 * @param name
