...
public class EditCommentDialog extends Dialog {
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText(noteID != 0 ? Messages.get().EditCommentDialog_EditComment
				: Messages.get().AlarmComments_AddCommentLink);

		IDialogSettings settings = Activator.getDefault().getDialogSettings();
		try {
			newShell.setSize(
					settings.getInt("EditCommentDialog.cx"), settings.getInt("EditCommentDialog.cy")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	protected Control createDialogArea(Composite parent) {
		...
		textControl = new LabeledText(dialogArea, SWT.NONE, SWT.BORDER
