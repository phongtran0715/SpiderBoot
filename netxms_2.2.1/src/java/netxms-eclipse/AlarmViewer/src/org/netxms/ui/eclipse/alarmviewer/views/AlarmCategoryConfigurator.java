...
public class AlarmCategoryConfigurator extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		dataView = new AlarmCategoryList(this, parent, SWT.NONE,
				TABLE_CONFIG_PREFIX, true);
	...
	private void activateContext() {
		...
		if (contextService != null) {
			contextService
					.activateContext("org.netxms.ui.eclipse.alarmviewer.context.AlarmCategoryConfigurator"); //$NON-NLS-1$
		}
	}
	...
	private void createActions() {
		...
		handlerService.activateHandler(dataView.getShowFilterAction()
