...
public class General extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		// Category ID
		WidgetHelper.createLabeledText(dialogArea, SWT.SINGLE | SWT.BORDER
				| SWT.READ_ONLY, SWT.DEFAULT, "Category ID",
				Long.toString(category.getId()),
				WidgetHelper.DEFAULT_LAYOUT_DATA);

		// Category name
		textName = WidgetHelper.createLabeledText(dialogArea, SWT.SINGLE
				| SWT.BORDER, SWT.DEFAULT, "Category name", category.getName(),
				WidgetHelper.DEFAULT_LAYOUT_DATA);

		// Category description
		textDescription = WidgetHelper.createLabeledText(dialogArea, SWT.MULTI
				| SWT.BORDER, SWT.DEFAULT, "Description",
	...
	protected boolean applyChanges(final boolean isApply) {
		...
		if (newName.equals(category.getName())
				&& newDescription.equals(category.getDescription()))
