...
public class AlarmCategoryListFilter extends ViewerFilter {
	...
	public boolean checkId(Object element) {
		if (Long.toString(((AlarmCategory) element).getId()).toLowerCase()
	...
	public boolean checkName(Object element) {
		if (((AlarmCategory) element).getName().toLowerCase()
				.contains(filterString))
			return true;
		return false;
	}
	...
	public boolean checkDescr(Object element) {
		if (((AlarmCategory) element).getDescription().toLowerCase()
				.contains(filterString))
			return true;
		return false;
	}
