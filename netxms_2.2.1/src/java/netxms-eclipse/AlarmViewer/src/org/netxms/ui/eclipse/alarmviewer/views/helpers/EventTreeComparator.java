...
public class EventTreeComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		case AlarmDetails.EV_COLUMN_SOURCE:
			result = session.getObjectName(e1.getSourceObjectId())
					.compareToIgnoreCase(
							session.getObjectName(e2.getSourceObjectId()));
			break;
		...
		return (((TreeViewer) viewer).getTree().getSortDirection() == SWT.UP) ? result
				: -result;
	}
}
