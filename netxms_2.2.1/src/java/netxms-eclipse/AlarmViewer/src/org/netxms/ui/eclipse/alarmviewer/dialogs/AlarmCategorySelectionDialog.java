...
public class AlarmCategorySelectionDialog extends Dialog {
	...
	protected void configureShell(Shell newShell) {
		...
		try {
			newShell.setSize(settings.getInt(TABLE_CONFIG_PREFIX + ".cx"),
					settings.getInt(TABLE_CONFIG_PREFIX + ".cy"));
	...
	protected Control createDialogArea(Composite parent) {
		...
		alarmCategoryList = new AlarmCategoryList(dialogArea, SWT.NONE,
				TABLE_CONFIG_PREFIX, false);
		...
		alarmCategoryList.getViewer().addDoubleClickListener(
	...
	protected void createButtonsForButtonBar(Composite parent) {
		...
		Button newButton = createButton(parent, IDialogConstants.NO_ID,
				"New category...", false);
	...
	protected void okPressed() {
		final IStructuredSelection selection = (IStructuredSelection) alarmCategoryList
				.getSelection();
	...
	private void saveSettings() {
		...
		settings.put(
				TABLE_CONFIG_PREFIX + ".Filter", alarmCategoryList.getFilterText()); //$NON-NLS-1$
	}
