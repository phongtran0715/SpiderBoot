 ...
 */
public class ToggleAlarmStatusColorsHandler extends AbstractHandler implements
		IElementUpdater {
	/*
	 * (non-Javadoc)
	 * 
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (object instanceof IEvaluationContext) {
			...
			if ((tab != null) && (tab instanceof AlarmTab)) {
				boolean isChecked = !Activator.getDefault()
						.getPreferenceStore()
	...
	public void updateElement(UIElement element, Map parameters) {
		element.setChecked(Activator.getDefault().getPreferenceStore()
				.getBoolean("SHOW_ALARM_STATUS_COLORS"));
	}
}
