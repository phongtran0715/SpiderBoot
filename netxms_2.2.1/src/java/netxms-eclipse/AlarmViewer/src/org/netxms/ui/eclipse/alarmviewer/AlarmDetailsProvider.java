...
public class AlarmDetailsProvider implements ObjectDetailsProvider {
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.objectview.api.ObjectDetailsProvider#canProvideDetails
	...
	public boolean canProvideDetails(AbstractObject object) {
		return (object instanceof AbstractNode)
				...
				|| (object instanceof Subnet) || (object instanceof Zone)
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.objectview.api.ObjectDetailsProvider#provideDetails
	 * (org.netxms.client.objects.AbstractObject, org.eclipse.ui.IViewPart)
	 */
	@Override
	public void provideDetails(AbstractObject object, IViewPart viewPart) {
		try {
			IWorkbenchPage page = (viewPart != null) ? viewPart.getSite()
					.getPage() : PlatformUI.getWorkbench()
					.getActiveWorkbenchWindow().getActivePage();
			page.showView(ObjectAlarmBrowser.ID,
					Long.toString(object.getObjectId()),
					IWorkbenchPage.VIEW_ACTIVATE);
		} catch (PartInitException e) {
			MessageDialogHelper.openError(
					(viewPart != null) ? viewPart.getSite().getShell() : null,
					Messages.get().AlarmDetailsProvider_Error,
					Messages.get().AlarmDetailsProvider_ErrorOpeningView
							+ e.getMessage());
		}
	}
}
