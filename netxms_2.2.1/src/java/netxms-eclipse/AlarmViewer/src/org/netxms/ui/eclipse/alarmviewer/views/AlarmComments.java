...
public class AlarmComments extends ViewPart {
	...
	private static final String[] stateImage = {
			"icons/outstanding.png", "icons/acknowledged.png", "icons/terminated.png" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	private void createAlarmDetailsSection() {
		final Section details = toolkit.createSection(form.getBody(),
				Section.TITLE_BAR);
	...
	private void refresh() {
		new ConsoleJob(Messages.get().AlarmComments_GetComments, this,
	...
	private void updateAlarmDetails(Alarm alarm) {
		...
		alarmState.setImage(imageCache.add(Activator
				.getImageDescriptor(stateImage[alarm.getState()])));
