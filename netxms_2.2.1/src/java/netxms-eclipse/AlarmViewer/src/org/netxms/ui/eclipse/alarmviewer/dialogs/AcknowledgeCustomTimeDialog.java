...
public class AcknowledgeCustomTimeDialog extends Dialog {
	...
	protected void okPressed() {
		time = days.getSelection() * 86400 + hours.getSelection() * 3600
				+ minutes.getSelection() * 60;
		if (time <= 0) {
			MessageDialogHelper.openWarning(getShell(),
					Messages.get().AcknowledgeCustomTimeDialog_Warning,
					Messages.get().AcknowledgeCustomTimeDialog_WarningZeroTime);
			return;
		}
		super.okPressed();
	}
