...
public class AlarmReminderDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		AlarmList list = new AlarmList(null, dialogArea, SWT.BORDER,
				"AlarmReminderDialog", null); //$NON-NLS-1$
	...
	protected void createButtonsForButtonBar(Composite parent) {
		createButton(parent, CANCEL,
				Messages.get().AlarmReminderDialog_Dismiss, false);
	}
}
