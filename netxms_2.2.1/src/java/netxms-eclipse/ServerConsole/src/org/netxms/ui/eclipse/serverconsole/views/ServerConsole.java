...
public class ServerConsole extends ViewPart implements ITerminalListener {
	...
	private void connectToServer() {
		new ConsoleJob(Messages.get().ServerConsole_OpenServerConsole, null,
	...
	private void setConnected() {
		...
		Thread inputReader = new Thread() {
			...
			public void run() {
				try {
					final TerminalReader in = new TerminalReader(
							new InputStreamReader(connector.getInputStream()),
							connector.getRemoteToTerminalOutputStream());
					while (true) {
	...
	private void createActions() {
		actionClear = new Action(Messages.get().ServerConsole_ClearTerminal,
		...
		actionScrollLock = new Action(Messages.get().ServerConsole_ScrollLock,
				Action.AS_CHECK_BOX) {
			@Override
			public void run() {
	 ...
	 * 
	 * @see
	 * org.eclipse.tm.internal.terminal.control.ITerminalListener#setState(org
	 * .eclipse.tm.internal.terminal.provisional.api.TerminalState)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.eclipse.tm.internal.terminal.control.ITerminalListener#setTerminalTitle
	 * (java.lang.String)
	 */
	@Override
