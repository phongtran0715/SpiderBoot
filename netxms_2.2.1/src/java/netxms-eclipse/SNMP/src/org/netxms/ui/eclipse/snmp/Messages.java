...
public class Messages extends NLS {
	...
	public static String OpenSnmpCredentialsEditor_CannotOpenView;
	public static String OpenSnmpCredentialsEditor_Error;
	...
	public static String SnmpCredentials_AddPort;
	public static String SnmpCredentials_CannotSaveConfig;
	public static String SnmpCredentials_ErrorLoadingConfig;
	public static String SnmpCredentials_ErrorSavingConfig;
	public static String SnmpCredentials_FormTitle;
	public static String SnmpCredentials_LoadingConfig;
	public static String SnmpCredentials_PleaseEnterPort;
	public static String SnmpCredentials_Ports;
	public static String SnmpCredentials_PortsDescription;
	public static String SnmpCredentials_SaveConfig;
