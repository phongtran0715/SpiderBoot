...
public class AddUsmCredDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		authMethod = WidgetHelper.createLabeledCombo(dialogArea, SWT.READ_ONLY,
				Messages.get().AddUsmCredDialog_Auth,
		...
		privMethod = WidgetHelper.createLabeledCombo(dialogArea, SWT.READ_ONLY,
				Messages.get().AddUsmCredDialog_Encryption,
				WidgetHelper.DEFAULT_LAYOUT_DATA);
