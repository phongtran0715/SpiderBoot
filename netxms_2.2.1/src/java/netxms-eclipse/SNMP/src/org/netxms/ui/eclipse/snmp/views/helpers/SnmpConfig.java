...
public class SnmpConfig {
	 ...
	 */
	public static SnmpConfig load(NXCSession session) throws NXCException,
			IOException {
	...
	/**
	 * Save SNMP configuration on server. This method calls communication API
	 * directly, so it should not be called from UI thread.
	 * 
	...
	/**
	 * @param usmCredentials
	 *            the usmCredentials to set
	 */
