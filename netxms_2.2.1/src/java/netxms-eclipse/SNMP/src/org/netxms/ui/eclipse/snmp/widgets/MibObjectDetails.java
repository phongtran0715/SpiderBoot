...
public class MibObjectDetails extends Composite {
	 ...
	 *            parent composite
	 * @param style
	 *            standard SWT styles for widget
	 * @param showOID
	 *            if true, "Object ID" input field will be shown
	 * @param mibTree
	 *            associated MIB tree
	 */
	public MibObjectDetails(Composite parent, int style, boolean showOID,
			MibBrowser mibTree) {
		super(parent, style);
		...
		if (showOID) {
			oid = WidgetHelper.createLabeledText(this, SWT.BORDER, 500,
					Messages.get().MibObjectDetails_OID,
			...
			oidText = WidgetHelper.createLabeledText(this, SWT.BORDER, 500,
					Messages.get().MibObjectDetails_OIDAsText,
					"", WidgetHelper.DEFAULT_LAYOUT_DATA); //$NON-NLS-1$
		...
		type = WidgetHelper.createLabeledText(infoGroup, SWT.BORDER
				| SWT.READ_ONLY, SWT.DEFAULT,
				Messages.get().MibObjectDetails_Type,
				"", WidgetHelper.DEFAULT_LAYOUT_DATA); //$NON-NLS-1$
		status = WidgetHelper.createLabeledText(infoGroup, SWT.BORDER
				| SWT.READ_ONLY, SWT.DEFAULT,
				Messages.get().MibObjectDetails_Status,
				"", WidgetHelper.DEFAULT_LAYOUT_DATA); //$NON-NLS-1$
		access = WidgetHelper.createLabeledText(infoGroup, SWT.BORDER
				| SWT.READ_ONLY, SWT.DEFAULT,
				Messages.get().MibObjectDetails_Access,
				"", WidgetHelper.DEFAULT_LAYOUT_DATA); //$NON-NLS-1$
		...
		description = WidgetHelper.createLabeledText(this, SWT.BORDER
				| SWT.MULTI | SWT.V_SCROLL | SWT.H_SCROLL | SWT.READ_ONLY, 500,
				Messages.get().MibObjectDetails_8, "", gd); //$NON-NLS-1$
		gd = new GridData();
		gd.grabExcessHorizontalSpace = true;
		gd.horizontalAlignment = SWT.FILL;
		gd.grabExcessVerticalSpace = true;
		...
		gd.grabExcessVerticalSpace = true;
		gd.verticalAlignment = SWT.FILL;
		textualConvention = WidgetHelper.createLabeledText(this, SWT.BORDER
				| SWT.MULTI | SWT.V_SCROLL | SWT.H_SCROLL | SWT.READ_ONLY, 500,
				Messages.get().MibObjectDetails_TextualConv, "", gd); //$NON-NLS-1$
		gd = new GridData();
		gd.grabExcessHorizontalSpace = true;
		gd.horizontalAlignment = SWT.FILL;
		gd.grabExcessVerticalSpace = true;
