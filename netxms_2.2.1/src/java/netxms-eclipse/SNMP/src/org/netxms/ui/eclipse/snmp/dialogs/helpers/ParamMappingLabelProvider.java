...
public class ParamMappingLabelProvider implements ITableLabelProvider {
	 ...
	 * 
	 * @param list
	 *            List of all parameter mappings
	 */
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case 1: // OID or position in trap
			return (pm.getType() == SnmpTrapParameterMapping.BY_OBJECT_ID) ? pm
					.getObjectId().toString()
					: (Messages.get().ParamMappingLabelProvider_PositionPrefix + Integer
							.toString(pm.getPosition()));
		}
		return null;
	}
