...
public class SnmpTrapMonitor extends AbstractTraceView {
	...
	public void init(IViewSite site) throws PartInitException {
		...
		initShowFilter = safeCast(settings.get("SnmpTrapMonitor.showFilter"),
				settings.getBoolean("SnmpTrapMonitor.showFilter"),
				initShowFilter);
	}
	...
	public void dispose() {
		...
		IDialogSettings settings = Activator.getDefault().getDialogSettings();
		settings.put("SnmpTrapMonitor.showFilter",
				traceWidget.isFilterEnabled());
		super.dispose();
	}
