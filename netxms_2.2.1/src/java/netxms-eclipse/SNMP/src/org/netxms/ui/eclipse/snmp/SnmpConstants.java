...
public class SnmpConstants {
	private static final String[] mibObjectStatus = { "", "Mandatory",
			"Optional", "Obsolete", "Deprecated", "Current" };
	private static final String[] mibObjectAccess = { "", "Read", "Read/Write",
			"Write", "None", "Notify", "Create" };
	private static final String[] mibObjectType = { "Other", "Import Item",
			"Object ID", "Bit String", "Integer", "Integer 32bits",
			"Integer 64bits", "Unsigned Int 32bits", "Counter",
			"Counter 32bits", "Counter 64bits", "Gauge", "Gauge 32bits",
			"Timeticks", "Octet String", "Opaque", "IP Address",
			"Physical Address", "Network Address", "Named Type", "Sequence ID",
			"Sequence", "Choice", "Textual Convention", "Macro", "MODCOMP",
			"Trap", "Notification", "Module ID", "NSAP Address",
			"Agent Capability", "Unsigned Integer", "Null", "Object Group",
			"Notification Group" };
	 ...
	 *            Array with texts
	 * @param code
	 *            Code to get text for
	 * @param defaultValue
	 *            Default value
	 * @return text for given code or default value in case of error
	 */
	private static String safeGetText(String[] texts, int code,
			String defaultValue) {
		String result;
		try {
			result = texts[code];
