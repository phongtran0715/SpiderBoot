...
public class EditActionDlg extends Dialog {
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText(createNew ? Messages.get().EditActionDlg_CreateAction
				: Messages.get().EditActionDlg_EditAction);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		name = WidgetHelper.createLabeledText(dialogArea, SWT.BORDER, 300,
				Messages.get().EditActionDlg_Name, action.getName(),
		...
		typeRemoteExec
				.setSelection(action.getType() == ServerAction.EXEC_REMOTE);
		...
		typeExecScript
				.setSelection(action.getType() == ServerAction.EXEC_NXSL_SCRIPT);
		...
		typeForward
				.setSelection(action.getType() == ServerAction.FORWARD_EVENT);
