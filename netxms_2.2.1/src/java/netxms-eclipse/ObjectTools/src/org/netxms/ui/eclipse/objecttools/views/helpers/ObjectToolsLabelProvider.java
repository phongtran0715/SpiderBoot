 ...
 * 
 */
public class ObjectToolsLabelProvider extends LabelProvider implements
		ITableLabelProvider {
	...
	public ObjectToolsLabelProvider() {
		toolTypeImages[0] = Activator.getImageDescriptor(
				"icons/internal_tool.gif").createImage(); //$NON-NLS-1$
		toolTypeImages[1] = Activator.getImageDescriptor(
				"icons/agent_action.gif").createImage(); //$NON-NLS-1$
		toolTypeImages[2] = Activator
				.getImageDescriptor("icons/table.gif").createImage(); //$NON-NLS-1$
		toolTypeImages[3] = Activator
				.getImageDescriptor("icons/table.gif").createImage(); //$NON-NLS-1$
		toolTypeImages[4] = Activator
				.getImageDescriptor("icons/url.gif").createImage(); //$NON-NLS-1$
		toolTypeImages[5] = Activator
				.getImageDescriptor("icons/console.png").createImage(); //$NON-NLS-1$
		toolTypeImages[6] = Activator
				.getImageDescriptor("icons/console.png").createImage(); //$NON-NLS-1$
		toolTypeImages[7] = Activator.getImageDescriptor(
				"icons/file_download.png").createImage(); //$NON-NLS-1$
		toolTypeImages[8] = Activator
				.getImageDescriptor("icons/script.png").createImage(); //$NON-NLS-1$
		toolTypeImages[9] = Activator
