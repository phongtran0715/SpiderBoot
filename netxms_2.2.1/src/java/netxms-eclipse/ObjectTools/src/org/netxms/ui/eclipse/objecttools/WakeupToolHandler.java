...
public class WakeupToolHandler implements ObjectToolHandler {
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.objecttools.api.ObjectToolHandler#canExecuteOnNode
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.objecttools.api.ObjectToolHandler#execute(org.netxms
	 * .client.objects.AbstractNode, org.netxms.client.objecttools.ObjectTool)
	 */
	@Override
	public void execute(final AbstractNode node, ObjectTool tool) {
		final NXCSession session = (NXCSession) ConsoleSharedData.getSession();
		new ConsoleJob(Messages.get().WakeupToolHandler_JobName, null,
