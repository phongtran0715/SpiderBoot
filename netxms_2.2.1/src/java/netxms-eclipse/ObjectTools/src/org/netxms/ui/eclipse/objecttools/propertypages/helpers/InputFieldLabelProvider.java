 ...
 */
public class InputFieldLabelProvider extends LabelProvider implements
		ITableLabelProvider {
	private final String[] typeNames = {
			Messages.get().InputFieldLabelProvider_Text,
			Messages.get().InputFieldLabelProvider_Password,
			Messages.get().InputFieldLabelProvider_Number };
