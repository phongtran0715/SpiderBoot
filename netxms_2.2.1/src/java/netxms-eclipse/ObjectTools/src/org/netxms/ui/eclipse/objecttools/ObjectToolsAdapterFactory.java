...
public class ObjectToolsAdapterFactory implements IAdapterFactory {
	private final class ToolDetailLoader implements IRunnableWithProgress {
		...
		private NXCSession session = (NXCSession) ConsoleSharedData
				.getSession();
						...
						MessageDialogHelper
								.openError(
										PlatformUI.getWorkbench()
												...
												.getShell(),
										Messages.get().ObjectToolsAdapterFactory_Error,
										String.format(
												Messages.get().ObjectToolsAdapterFactory_LoaderErrorText,
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		...
		if (adapterType == ObjectToolDetails.class) {
			...
			if (details == null) {
				ToolDetailLoader job = new ToolDetailLoader(toolId, PlatformUI
