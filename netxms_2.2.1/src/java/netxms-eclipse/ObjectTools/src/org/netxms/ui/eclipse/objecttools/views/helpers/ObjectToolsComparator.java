...
public class ObjectToolsComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object e1, Object e2) {
		...
		case ObjectToolsEditor.COLUMN_TYPE:
			result = ObjectToolsLabelProvider.getToolTypeName(tool1).compareTo(
					ObjectToolsLabelProvider.getToolTypeName(tool2));
			break;
		case ObjectToolsEditor.COLUMN_DESCRIPTION:
			result = tool1.getDescription().compareToIgnoreCase(
					tool2.getDescription());
			break;
		default:
			result = 0;
			break;
