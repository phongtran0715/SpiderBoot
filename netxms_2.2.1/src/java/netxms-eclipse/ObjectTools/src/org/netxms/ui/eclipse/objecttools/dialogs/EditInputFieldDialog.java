...
public class EditInputFieldDialog extends Dialog {
	private final String[] typeNames = {
			Messages.get().EditInputFieldDialog_Text,
			Messages.get().EditInputFieldDialog_Password,
			Messages.get().EditInputFieldDialog_Number };
	 ...
	 * @param snmpColumn
	 */
	public EditInputFieldDialog(Shell parentShell, boolean create,
			InputField field) {
		super(parentShell);
		this.create = create;
		this.field = field;
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText(create ? Messages.get().EditInputFieldDialog_AddInputField
				: Messages.get().EditInputFieldDialog_EditInputField);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		type = WidgetHelper.createLabeledCombo(dialogArea, SWT.READ_ONLY,
				Messages.get().EditInputFieldDialog_Type,
		...
		type.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				checkValidatePassword.setVisible(InputFieldType.getByValue(type
						.getSelectionIndex()) == InputFieldType.PASSWORD);
			}
		...
		checkValidatePassword
				.setText(Messages.get().EditInputFieldDialog_ValidatePassword);
		checkValidatePassword
				.setVisible(field.getType() == InputFieldType.PASSWORD);
