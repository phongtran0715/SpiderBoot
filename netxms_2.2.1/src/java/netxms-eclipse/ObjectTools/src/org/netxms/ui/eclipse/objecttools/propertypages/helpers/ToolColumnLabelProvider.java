 ...
 * 
 */
public class ToolColumnLabelProvider extends LabelProvider implements
		ITableLabelProvider {
	private final String[] formatName = {
			Messages.get().ToolColumnLabelProvider_FmtString,
			Messages.get().ToolColumnLabelProvider_FmtInteger,
			Messages.get().ToolColumnLabelProvider_FmtFloat,
			Messages.get().ToolColumnLabelProvider_FmtIpAddr,
			Messages.get().ToolColumnLabelProvider_FmtMacAddr,
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case 2:
			return snmpTable ? ((ObjectToolTableColumn) element).getSnmpOid()
					: Integer.toString(((ObjectToolTableColumn) element)
							.getSubstringIndex());
		}
		return null;
	}
