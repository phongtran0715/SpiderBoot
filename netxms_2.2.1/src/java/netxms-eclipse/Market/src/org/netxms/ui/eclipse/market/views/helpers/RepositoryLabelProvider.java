...
public class RepositoryLabelProvider extends LabelProvider implements
	...
	private Image imageEvent = Activator.getImageDescriptor("icons/event.gif")
			.createImage();
	private Image imageRepository = Activator.getImageDescriptor(
			"icons/repository.gif").createImage();
	private Image imageTemplate = Activator.getImageDescriptor(
			"icons/template.png").createImage();
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case 1:
			if (object instanceof RepositoryElement)
				return Integer.toString(((RepositoryElement) object)
						.getActualVersion());
			return "";
		case 2:
	...
	public Font getFont(Object element) {
		if ((element instanceof RepositoryElement)
				&& ((RepositoryElement) element).isMarked())
			return markFont;
		return null;
	}
