 ...
 * Event trace widget
 */
public class EventTraceWidget extends AbstractTraceWidget implements
		SessionListener {
	...
	protected void createActions() {
		...
		actionShowColor = new Action(
				Messages.get().EventMonitor_ShowStatusColors,
				Action.AS_CHECK_BOX) {
			@Override
			public void run() {
		...
		actionShowIcons = new Action(
				Messages.get().EventMonitor_ShowStatusIcons,
				Action.AS_CHECK_BOX) {
			@Override
			public void run() {
