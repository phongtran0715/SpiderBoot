...
public class EventLabelProvider extends LabelProvider implements
	...
	public Color getForeground(Object element) {
		return showColor ? FOREGROUND_COLORS[((Event) element).getSeverity()]
				: null;
	}
	...
	public Color getBackground(Object element) {
		return showColor ? StatusDisplayInfo.getStatusColor(((Event) element)
				.getSeverity()) : null;
	}
	...
	public Image getColumnImage(Object element, int columnIndex) {
		if (showIcons && (columnIndex == 0)) {
			return StatusDisplayInfo.getStatusImage(((Event) element)
					.getSeverity());
		}
		return null;
	}
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case EventTraceWidget.COLUMN_SOURCE:
			final AbstractObject object = session.findObjectById(event
					.getSourceId());
			return (object != null) ? object.getObjectName()
					: Messages.get().EventLabelProvider_Unknown;
