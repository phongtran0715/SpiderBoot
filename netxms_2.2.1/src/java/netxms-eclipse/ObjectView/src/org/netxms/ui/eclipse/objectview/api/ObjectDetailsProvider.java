...
public interface ObjectDetailsProvider {
	/**
	 * Called by framework to check if provider can provide detailed information
	 * for given object.
	 * 
	 * @param object
	 *            object to evaluate
	 ...
	 * 
	 * @param object
	 *            object to provide information for
	 * @param viewPart
	 *            active view, can be null
	 */
	public abstract void provideDetails(AbstractObject object,
			IViewPart viewPart);
}
