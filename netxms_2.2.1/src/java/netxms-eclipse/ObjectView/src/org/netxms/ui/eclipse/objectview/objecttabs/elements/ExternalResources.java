...
public class ExternalResources extends OverviewPageElement {
	 ...
	 * @param objectTab
	 */
	public ExternalResources(Composite parent, OverviewPageElement anchor,
			ObjectTab objectTab) {
	...
	private void openUrl(URL url) {
		try {
			...
			Activator
					.log("Exception when trying to open URL "
							+ url.toExternalForm(), e);
			MessageDialogHelper.openError(PlatformUI.getWorkbench()
					.getActiveWorkbenchWindow().getShell(), "Error",
					"Cannot start external web browser");
		}
	}
	...
	private class Element {
		...
		Element(Composite parent, ObjectUrl url) {
			...
			link.setForeground(SharedColors.getColor(
					SharedColors.COMMAND_BOX_TEXT, link.getDisplay()));
