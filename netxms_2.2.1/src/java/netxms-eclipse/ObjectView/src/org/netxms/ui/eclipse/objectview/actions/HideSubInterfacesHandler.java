...
/**
 * Command handler for toggling show/hide sub-interfaces
 */
public class HideSubInterfacesHandler extends AbstractHandler implements
		IElementUpdater {
	/*
	 * (non-Javadoc)
	 * 
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (object instanceof IEvaluationContext) {
			Object tab = ((IEvaluationContext) object)
					.getVariable("org.netxms.ui.eclipse.objectview.ActiveTab"); //$NON-NLS-1$
