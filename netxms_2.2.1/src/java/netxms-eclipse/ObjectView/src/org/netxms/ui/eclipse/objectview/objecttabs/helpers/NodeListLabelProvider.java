 ...
 */
public class NodeListLabelProvider extends LabelProvider implements
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case NodesTab.COLUMN_IP_ADDRESS:
			return node.getPrimaryIP().isValidUnicastAddress() ? node
					.getPrimaryIP().getHostAddress() : null;
