...
public class InterfaceListComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object e1, Object e2) {
		...
		case InterfacesTab.COLUMN_8021X_BACKEND_STATE:
			result = iface1.getDot1xBackendState()
					- iface2.getDot1xBackendState();
			break;
		...
		case InterfacesTab.COLUMN_ALIAS:
			result = NaturalOrderComparator.compare(iface1.getAlias(),
					iface2.getAlias());
			break;
		case InterfacesTab.COLUMN_DESCRIPTION:
			result = NaturalOrderComparator.compare(iface1.getDescription(),
					iface2.getDescription());
			break;
		...
		case InterfacesTab.COLUMN_NAME:
			result = NaturalOrderComparator.compare(iface1.getObjectName(),
					iface2.getObjectName());
			break;
		...
		case InterfacesTab.COLUMN_IP_ADDRESS:
			result = ComparatorHelper.compareInetAddresses(
					iface1.getFirstUnicastAddress(),
					iface2.getFirstUnicastAddress());
			break;
		default:
			result = 0;
			break;
