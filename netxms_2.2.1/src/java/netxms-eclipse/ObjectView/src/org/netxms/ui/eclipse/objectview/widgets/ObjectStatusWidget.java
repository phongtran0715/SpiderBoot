...
public class ObjectStatusWidget extends Canvas implements PaintListener {
	...
	public void paintControl(PaintEvent e) {
		...
		e.gc.setForeground(SharedColors.getColor(SharedColors.TEXT_NORMAL,
				getDisplay()));
		e.gc.setLineWidth(1);
		...
		final String text = (object instanceof AbstractNode) ? (object
		...
		int h = e.gc
				.textExtent(text, SWT.DRAW_TRANSPARENT | SWT.DRAW_DELIMITER).y;
		e.gc.drawText(text, rect.x, rect.y + (rect.height - h) / 2,
