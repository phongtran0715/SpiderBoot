 ...
 */
public class OverviewDciLabelProvider extends LabelProvider implements
	...
	public Image getColumnImage(Object element, int columnIndex) {
		if (columnIndex == 0)
			return (((DciValue) element).getErrorCount() > 0) ? StatusDisplayInfo
					.getStatusImage(ObjectStatus.UNKNOWN)
					: StatusDisplayInfo.getStatusImage(((DciValue) element)
	...
	public Color getForeground(Object element) {
		if (((DciValue) element).getErrorCount() > 0)
			return SharedColors.getColor(SharedColors.TEXT_ERROR,
					Display.getCurrent());
		return null;
	}
