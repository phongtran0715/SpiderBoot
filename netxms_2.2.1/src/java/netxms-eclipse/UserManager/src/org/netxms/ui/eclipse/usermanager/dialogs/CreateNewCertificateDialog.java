...
public class CreateNewCertificateDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		textFileName = WidgetHelper.createLabeledText(dialogArea, SWT.BORDER,
				300, Messages.get().CreateNewCertificateDialog_FileNameLabel,
				null, WidgetHelper.DEFAULT_LAYOUT_DATA);

		browseButton = new Button(dialogArea, SWT.PUSH);
		browseButton
				.setText(Messages.get().CreateNewCertificateDialog_BrowseLabel);
		...
		textComments
				.setLabel(Messages.get().CreateNewCertificateDialog_CertificateCommentLabel);
	...
	public byte[] readFile(String filename) throws CertificateException,
