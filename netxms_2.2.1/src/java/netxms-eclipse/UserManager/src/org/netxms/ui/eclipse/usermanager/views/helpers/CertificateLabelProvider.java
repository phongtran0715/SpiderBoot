 ...
 */
public class CertificateLabelProvider extends WorkbenchLabelProvider implements
		ITableLabelProvider {
	/*
	 * (non-Javadoc)
	 * 
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case CertificateView.COLUMN_ID:
			return (element instanceof AuthCertificate) ? Long
					.toString(((AuthCertificate) element).getId()) : null;
		...
		case CertificateView.COLUMN_COMMENTS:
			return (element instanceof AuthCertificate) ? ((AuthCertificate) element)
					.getComments() : null;
