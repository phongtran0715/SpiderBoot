...
public class MapAccessor {
	...
	public String generateUrl() {
		...
		// StringBuilder("http://maps.google.com/staticmap?format=png32&center=");
		StringBuilder sb = new StringBuilder(
				"http://staticmap.openstreetmap.de/staticmap.php?maptype=mapnik&format=png32&center="); //$NON-NLS-1$
