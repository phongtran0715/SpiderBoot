 ...
 */
public abstract class AbstractGeolocationView extends ViewPart implements
		ISelectionProvider {
	...
	private void activateContext() {
		...
		if (contextService != null) {
			contextService
					.activateContext("org.netxms.ui.eclipse.osm.context.Geolocation"); //$NON-NLS-1$
		}
	}
	 ...
	 * @return
	 */
	protected abstract AbstractGeoMapViewer createMapViewer(Composite parent,
			int style);
	...
	protected void fillContextMenu(final IMenuManager manager) {
		...
		selection = (object != null) ? new StructuredSelection(object)
	...
	private void setZoomLevel(int newLevel) {
		if ((newLevel < MapAccessor.MIN_MAP_ZOOM)
				|| (newLevel > MapAccessor.MAX_MAP_ZOOM))
			return;
