...
public class WorldMap extends AbstractGeolocationView {
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.osm.views.AbstractGeolocationView#createPartControl
	...
	public void createPartControl(Composite parent) {
		...
		initialZoom = settings.get(ID + "zoom") != null ? settings.getInt(ID
				+ "zoom") : 2;
		if (settings.get(ID + "latitude") != null
				&& settings.get(ID + "longitude") != null)
			initialLocation = new GeoLocation(settings.getDouble(ID
					+ "latitude"), settings.getDouble(ID + "longitude"));
		filterEnabled = settings.get(ID + "filterEnabled") != null ? settings
				.getBoolean(ID + "filterEnabled") : true;
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.osm.views.AbstractGeolocationView#createMapViewer
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.osm.views.AbstractGeolocationView#getInitialCenterPoint
	 * ()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.osm.views.AbstractGeolocationView#getInitialZoomLevel
	 * ()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.osm.views.AbstractGeolocationView#createActions()
	 */
	@Override
	protected void createActions() {
		...
		actionShowFilter
				.setActionDefinitionId("org.netxms.ui.eclipse.worldmap.commands.show_filter"); //$NON-NLS-1$
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.osm.views.AbstractGeolocationView#fillContextMenu
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.osm.views.AbstractGeolocationView#fillLocalPullDown
	 * (org.eclipse.jface.action.IMenuManager)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.osm.views.AbstractGeolocationView#fillLocalToolBar
	...
	private void placeObject() {
		...
		if (dlg.open() == Window.OK) {
			final NXCObjectModificationData md = new NXCObjectModificationData(
					dlg.getSelectedObjects().get(0).getObjectId());
			md.setGeolocation(map.getLocationAtPoint(map.getCurrentPoint()));
			final NXCSession session = ConsoleSharedData.getSession();
			new ConsoleJob(Messages.get().WorldMap_JobTitle, this,
	...
	private void onFilterModify() {
		((ObjectGeoLocationViewer) map).setFilterString(filterControl.getText()
				.trim().toLowerCase());
		map.reloadMap();
	}
