...
public class ExecuteServerScript extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			window.getActivePage().showView(ScriptExecutor.ID,
					Long.toString(((AbstractObject) object).getObjectId()),
					IWorkbenchPage.VIEW_ACTIVATE);
		} catch (PartInitException e) {
			MessageDialogHelper.openError(window.getShell(),
					Messages.get().ExecuteServerScript_Error, String.format(
							Messages.get().ExecuteServerScript_ErrorMessage,
