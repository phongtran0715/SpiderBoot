...
public class NXSLSourceViewerConfiguration extends SourceViewerConfiguration {
	...
	private static final String[] nxslKeywords = { "array", "break", "case",
			"const", "classof", "continue", "default", "do", "else", "exit",
			"FALSE", "false", "for", "foreach", "global", "if", "ilike",
			"imatch", "int32", "int64", "like", "match", "NULL", "null",
			"print", "println", "real", "return", "string", "sub", "switch",
			"TRUE", "true", "typeof", "uint32", "uint64", "use", "while" };

	private static final IRule[] codeRules = { new KeywordRule(
			nxslWordDetector,
			NXSLTextAttributeProvider
					.getTextAttributeToken(NXSLTextAttributeProvider.KEYWORD),
			NXSLTextAttributeProvider
					.getTextAttributeToken(NXSLTextAttributeProvider.DEFAULT),
			nxslKeywords) };
	...
	public IPresentationReconciler getPresentationReconciler(
		...
		scanner.setDefaultReturnToken(NXSLTextAttributeProvider
				.getTextAttributeToken(NXSLTextAttributeProvider.DEFAULT));
		...
		dr = new DefaultDamagerRepairer(new SingleTokenScanner(
				NXSLTextAttributeProvider
						.getTextAttribute(NXSLTextAttributeProvider.COMMENT)));
		...
		scanner.setRules(new IRule[] { new PatternRule(
				...
				"\n",
				NXSLTextAttributeProvider
						.getTextAttributeToken(NXSLTextAttributeProvider.ERROR),
				(char) 0, false) });
		scanner.setDefaultReturnToken(NXSLTextAttributeProvider
				.getTextAttributeToken(NXSLTextAttributeProvider.STRING));
