 ...
 * 
 */
public class NXSLTextAttributeProvider {
	private static final Color DEFAULT_COLOR = new Color(Display.getCurrent(),
			0, 0, 0);
	...
	public static TextAttribute getTextAttribute(int element) {
		...
		case CONSTANT:
			return new TextAttribute(CONSTANT_COLOR);
		case ERROR:
	...
	/**
	 * Get token containing text attribute for given element (keyword, comment,
	 * etc.)
	 * 
	 * @param element
	 *            source code element
