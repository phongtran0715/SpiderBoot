...
public class SaveScriptDialog extends Dialog {
	...
	protected void createButtonsForButtonBar(Composite parent) {
		createButton(parent, SAVE_ID, Messages.get().SaveScriptDialog_Save,
				false);
		createButton(parent, SAVE_AS_ID,
				Messages.get().SaveScriptDialog_SaveAs, false);
		createButton(parent, DISCARD_ID,
				Messages.get().SaveScriptDialog_Discard, false);
		createButton(parent, IDialogConstants.CANCEL_ID,
				Messages.get().SaveScriptDialog_Cancel, false);
