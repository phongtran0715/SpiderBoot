...
public class ActionSelectionDialog extends Dialog {
	...
	public ActionSelectionDialog(Shell parentShell,
			Collection<ServerAction> actions) {
		super(parentShell);
	...
	protected void configureShell(Shell newShell) {
		...
		try {
			newShell.setSize(
					settings.getInt("SelectAction.cx"), settings.getInt("SelectAction.cy")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	protected Control createDialogArea(Composite parent) {
		...
		new Label(dialogArea, SWT.NONE)
				.setText(Messages.get().ActionSelectionDialog_Filter);
		...
		eventList = new TableViewer(dialogArea, SWT.BORDER | SWT.FULL_SELECTION
