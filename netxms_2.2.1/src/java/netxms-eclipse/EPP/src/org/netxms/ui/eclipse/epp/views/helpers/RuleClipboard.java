...
public class RuleClipboard {
	private List<EventProcessingPolicyRule> content = new ArrayList<EventProcessingPolicyRule>(
			0);
	...
	public Collection<EventProcessingPolicyRule> paste() {
		List<EventProcessingPolicyRule> list = new ArrayList<EventProcessingPolicyRule>(
				content.size());
		if (cloneOnPaste) {
