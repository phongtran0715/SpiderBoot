 ...
 * 
 */
public class CreateServiceCheckDialog extends Dialog {
	 ...
	 * @param parentShell
	 */
	public CreateServiceCheckDialog(Shell parentShell) {
		super(parentShell);
	}
	...
	protected void okPressed() {
		...
		if (name.isEmpty()) {
			MessageDialogHelper.openWarning(getShell(),
					Messages.get().CreateServiceCheckDialog_Warning,
					Messages.get().CreateServiceCheckDialog_WarningText);
			return;
		}
