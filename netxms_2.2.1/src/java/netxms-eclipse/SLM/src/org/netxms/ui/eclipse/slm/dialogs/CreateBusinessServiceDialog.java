...
public class CreateBusinessServiceDialog extends Dialog {
	 ...
	 * @param parentShell
	 */
	public CreateBusinessServiceDialog(Shell parentShell) {
		super(parentShell);
	}
	...
	protected void okPressed() {
		...
		if (name.isEmpty()) {
			MessageDialogHelper.openWarning(getShell(),
					Messages.get().CreateBusinessServiceDialog_Warning,
					Messages.get().CreateBusinessServiceDialog_WarningText);
			return;
		}
