...
public class ImageSelectionDialog extends Dialog implements SelectionListener,
		MouseListener, ImageUpdateListener {
	/**
	 * Zero
	 */
	...
	protected void configureShell(Shell newShell) {
		...
		try {
			newShell.setSize(settings.getInt(SELECT_IMAGE_CX),
					settings.getInt(SELECT_IMAGE_CY));
	...
	protected void createButtonsForButtonBar(Composite parent) {
		if ((flags & ALLOW_DEFAULT) == ALLOW_DEFAULT) {
			createButton(parent, DEFAULT_ID,
					Messages.get().ImageSelectionDialog_Default, false);
		}
	...
	public UUID getGuid() {
		return libraryImage == null ? NXCommon.EMPTY_GUID : libraryImage
				.getGuid();
	}
