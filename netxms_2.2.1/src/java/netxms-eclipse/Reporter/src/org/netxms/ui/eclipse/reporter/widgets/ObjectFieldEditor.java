...
public class ObjectFieldEditor extends FieldEditor {
	 ...
	 * @param parent
	 */
	public ObjectFieldEditor(ReportParameter parameter, FormToolkit toolkit,
			Composite parent) {
	...
	protected Control createContent(Composite parent) {
		...
		selectionLink
				.setToolTipText(Messages.get().ObjectFieldEditor_SelectObject);
		...
		clearLink
				.setToolTipText(Messages.get().ObjectFieldEditor_ClearSelection);
