...
public class ReportView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		selectionListener = new ISelectionListener() {
			...
			public void selectionChanged(IWorkbenchPart part,
				...
				if ((part instanceof ReportNavigator)
						&& (selection instanceof IStructuredSelection)
						&& !selection.isEmpty()) {
					ReportDefinition object = (ReportDefinition) ((IStructuredSelection) selection)
							.getFirstElement();
					setObject(object);
				}
			}
	...
	protected void setObject(ReportDefinition definition) {
		...
		executionForm = new ReportExecutionForm(parentComposite, SWT.NONE,
				definition, this);
