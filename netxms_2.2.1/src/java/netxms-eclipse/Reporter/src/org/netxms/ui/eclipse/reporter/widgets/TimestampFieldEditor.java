...
public class TimestampFieldEditor extends FieldEditor {
	 ...
	 * @param parent
	 */
	public TimestampFieldEditor(ReportParameter parameter, FormToolkit toolkit,
			Composite parent) {
	...
	protected Control createContent(Composite parent) {
		...
		if (type == Type.TIMESTAMP) {
			...
			timePicker.setTime(c.get(Calendar.HOUR_OF_DAY),
	...
	public String getValue() {
		...
		case START_DATE:
			calendar.set(datePicker.getYear(), datePicker.getMonth(),
					datePicker.getDay(), 0, 0, 0);
			break;
		case END_DATE:
			calendar.set(datePicker.getYear(), datePicker.getMonth(),
					datePicker.getDay(), 23, 59, 59);
			break;
		case TIMESTAMP:
			calendar.set(datePicker.getYear(), datePicker.getMonth(),
					datePicker.getDay(), timePicker.getHours(),
