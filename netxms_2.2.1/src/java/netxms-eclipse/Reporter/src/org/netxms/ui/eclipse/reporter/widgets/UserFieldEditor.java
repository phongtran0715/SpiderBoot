...
public class UserFieldEditor extends FieldEditor {
	...
	public UserFieldEditor(ReportParameter parameter, FormToolkit toolkit,
			Composite parent, boolean returnName) {
	...
	protected void selectUser() {
		final SelectUserDialog dialog = new SelectUserDialog(getShell(),
				User.class);
