...
public class StartClientToAgentFolderUploadDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		fileSelector = new LocalFolderSelector(dialogArea, SWT.NONE, false,
				SWT.OPEN);
		fileSelector
				.setLabel(Messages.get().StartClientToServerFileUploadDialog_LocalFile);
		...
		textRemoteFile
				.setLabel(Messages.get().StartClientToServerFileUploadDialog_RemoteFileName);
		gd = new GridData();
		gd.horizontalAlignment = SWT.FILL;
		gd.grabExcessHorizontalSpace = true;
	...
	protected void okPressed() {
		...
		if (localFile == null) {
			MessageDialogHelper
					.openWarning(
							getShell(),
							Messages.get().StartClientToServerFileUploadDialog_Warning,
							Messages.get().StartClientToServerFileUploadDialog_WarningText);
			return;
		}
