...
public class AgentFileAdapterFactory implements IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if ((adapterType == IWorkbenchAdapter.class)
				&& (adaptableObject instanceof AgentFile)) {
			return new IWorkbenchAdapter() {
				...
				public ImageDescriptor getImageDescriptor(Object object) {
					...
					if (ext.equalsIgnoreCase("tar") || ext.equalsIgnoreCase("gz") || //$NON-NLS-1$ //$NON-NLS-2$
						...
						return Activator
								.getImageDescriptor("icons/types/archive.png"); //$NON-NLS-1$
