...
public class DataSources extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		final String[] columnNames = { Messages.get().DataSources_ColPosition,
				Messages.get().DataSources_ColNode,
				Messages.get().DataSources_ColParameter,
				Messages.get().DataSources_ColLabel,
				Messages.get().DataSources_ColColor };
	...
	protected void applyChanges(final boolean isApply) {
		...
		if ((config instanceof GraphSettings) && isApply) {
			...
			final NXCSession session = (NXCSession) ConsoleSharedData
					.getSession();
			new ConsoleJob(Messages.get().DataSources_JobName, null,
