...
public class HistoricalDataSelectionDialog extends Dialog {
	 ...
	 * @param parentShell
	 */
	public HistoricalDataSelectionDialog(Shell parentShell, int maxRecords,
	...
	protected Control createDialogArea(Composite parent) {
		...
		radioLastRecords
				.setText(Messages.get().HistoricalDataSelectionDialog_LastRecords);
		...
		radioTimeFrame
				.setText(Messages.get().HistoricalDataSelectionDialog_TimeFrame);
		gd = new GridData();
		gd.horizontalSpan = 3;
		gd.verticalIndent = 5;
