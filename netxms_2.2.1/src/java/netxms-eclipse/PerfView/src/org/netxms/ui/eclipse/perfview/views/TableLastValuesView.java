...
public class TableLastValuesView extends ViewPart {
	...
	public void init(IViewSite site) throws PartInitException {
		...
		if ((object == null)
				|| (!(object instanceof AbstractNode)
						&& !(object instanceof Cluster) && !(object instanceof MobileDevice)))
			throw new PartInitException(
					Messages.get().TableLastValuesView_InvalidObjectID);
	...
	private void createActions() {
		...
		actionExportAllToCsv = new ExportToCsvAction(this, viewer.getViewer(),
				false);
	}
	...
	private void activateContext() {
		...
		if (contextService != null) {
			contextService
					.activateContext("org.netxms.ui.eclipse.perfview.context.TableLastValuesView"); //$NON-NLS-1$
		}
	}
