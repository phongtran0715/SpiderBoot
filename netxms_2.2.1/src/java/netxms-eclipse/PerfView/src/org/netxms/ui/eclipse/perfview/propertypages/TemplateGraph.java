...
public class TemplateGraph extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		acl = new HashMap<Long, AccessListElement>(settings.getAccessList()
				.size());
		...
		final String[] columnNames = {
				Messages.get().PredefinedGraph_LoginName,
				Messages.get().PredefinedGraph_Rights };
		...
		addButton.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				SelectUserDialog dlg = new SelectUserDialog(TemplateGraph.this
		...
		createAccessCheck(rights, Messages.get().PredefinedGraph_Read,
				GraphSettings.ACCESS_READ);
		createAccessCheck(rights, Messages.get().PredefinedGraph_Modify,
				GraphSettings.ACCESS_WRITE);
	...
	protected void applyChanges(final boolean isApply) {
		...
		if (isApply) {
			...
			final NXCSession session = (NXCSession) ConsoleSharedData
					.getSession();
			new ConsoleJob("Update access control list for template graph",
