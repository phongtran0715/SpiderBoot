...
public class PerfTabGraphSettings {
	 ...
	 */
	public static PerfTabGraphSettings createFromXml(final String xml)
			throws Exception {
	...
	public String getRuntimeTitle() {
		String t = ((title == null) || title.isEmpty()) ? ((runtimeDciInfo != null) ? runtimeDciInfo
				.getDescription() : "") : title; //$NON-NLS-1$
		return t.replace(
				"{instance}", (runtimeDciInfo != null) ? runtimeDciInfo.getInstance() : ""); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public String getGroupName() {
		if (groupName != null)
			return runtimeDciInfo != null ? groupName.replace("{instance}",
					runtimeDciInfo.getInstance()) : groupName;
	...
	/**
	 * @param runtimeDciInfo
	 *            the runtimeDciInfo to set
	 */
	...
	public String getRuntimeName() {
		String n = ((name == null) || name.isEmpty()) ? ((runtimeDciInfo != null) ? runtimeDciInfo
				.getDescription() : "") : name; //$NON-NLS-1$
		return n.replace(
				"{instance}", (runtimeDciInfo != null) ? runtimeDciInfo.getInstance() : ""); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	/**
	 * @param showLegendAlways
	 *            the showLegendAlways to set
	 */
	 ...
	 * 
	 * @param modifyYBase
	 *            if true, use min DCI value as Y base
	 */
