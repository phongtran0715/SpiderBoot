...
public class DashboardDynamicView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		selectionListener = new ISelectionListener() {
			...
			public void selectionChanged(IWorkbenchPart part,
				...
				if ((part instanceof DashboardNavigator)
	...
	private void setObject(Dashboard object) {
		if (dbc != null)
			dbc.dispose();
		dashboard = object;
		dbc = new DashboardControl(parentComposite, SWT.NONE, dashboard, this,
				selectionProvider, false);
		parentComposite.layout();
		setPartName(Messages.get().DashboardDynamicView_PartNamePrefix
	...
	private void rebuildDashboard() {
		...
		if (dbc != null)
			dbc.dispose();
		dashboard = (Dashboard) ((NXCSession) ConsoleSharedData.getSession())
				.findObjectById(dashboard.getObjectId(), Dashboard.class);
		if (dashboard != null) {
			dbc = new DashboardControl(parentComposite, SWT.NONE, dashboard,
					this, selectionProvider, false);
			parentComposite.layout();
			setPartName(Messages.get().DashboardDynamicView_PartNamePrefix
					+ dashboard.getObjectName());
		} else {
