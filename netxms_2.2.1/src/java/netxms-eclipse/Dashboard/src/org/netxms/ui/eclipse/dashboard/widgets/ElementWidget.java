 ...
 */
public class ElementWidget extends DashboardComposite implements
		ControlListener {
	 ...
	 * @param style
	 */
	protected ElementWidget(DashboardControl parent, int style,
	...
	/**
	 * Request layout run for entire dashboard. Can be called by subclasses when
	 * complete dashboard layout re-run is needed.
	 */
