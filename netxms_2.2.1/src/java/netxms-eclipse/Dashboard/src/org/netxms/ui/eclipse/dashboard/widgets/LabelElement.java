...
public class LabelElement extends ElementWidget {
	...
	public LabelElement(DashboardControl parent, DashboardElement element,
		...
		label.setBackground(ColorConverter.colorFromInt(
				config.getBackgroundColorAsInt(), colors));
		label.setForeground(ColorConverter.colorFromInt(
				config.getForegroundColorAsInt(), colors));
		setBackground(ColorConverter.colorFromInt(
				config.getBackgroundColorAsInt(), colors));
