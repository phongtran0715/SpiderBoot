...
public class SeparatorElement extends ElementWidget {
	 ...
	 * @param data
	 */
	public SeparatorElement(DashboardControl parent, DashboardElement element,
			IViewPart viewPart) {
		...
		bkColor = new Color(getDisplay(), ColorConverter.rgbFromInt(config
				.getBackgroundColorAsInt()));
		fgColor = new Color(getDisplay(), ColorConverter.rgbFromInt(config
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.widgets.DashboardComposite#paintControl(org.eclipse
	...
	public Point computeSize(int wHint, int hHint, boolean changed) {
		return new Point(
				(wHint == SWT.DEFAULT) ? (config.getLeftMargin() + config.getRightMargin())
						: wHint, config.getTopMargin()
						+ config.getBottomMargin() + config.getLineWidth());
	}
}
