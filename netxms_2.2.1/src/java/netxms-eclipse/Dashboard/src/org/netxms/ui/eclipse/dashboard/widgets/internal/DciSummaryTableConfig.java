...
public class DciSummaryTableConfig extends DashboardElementConfig {
	 ...
	 */
	public static DciSummaryTableConfig createFromXml(final String xml)
			throws Exception {
	...
	/**
	 * @param enableSortingAndLineLimit
	 *            the enableSortingAndLineLimit to set
	 */
