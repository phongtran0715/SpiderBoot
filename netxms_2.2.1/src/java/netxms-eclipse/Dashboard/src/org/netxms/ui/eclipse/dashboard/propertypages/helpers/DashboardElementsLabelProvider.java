 ...
 */
public class DashboardElementsLabelProvider extends LabelProvider implements
		ITableLabelProvider {
	private static final String[] ELEMENT_TYPES = {
			...
			"Syslog monitor", "SNMP trap monitor", "Event monitor",
			"Service component map", "Rack diagram" };
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case DashboardElements.COLUMN_SPAN:
			try {
				DashboardElementLayout layout = DashboardElementLayout
						.createFromXml(de.getLayout());
				return Integer.toString(layout.horizontalSpan)
						+ " / " + Integer.toString(layout.verticalSpan); //$NON-NLS-1$
			} catch (Exception e) {
