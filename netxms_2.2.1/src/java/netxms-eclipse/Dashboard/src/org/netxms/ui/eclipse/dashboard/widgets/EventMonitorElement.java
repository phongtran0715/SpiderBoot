...
public class EventMonitorElement extends ElementWidget {
	...
	protected EventMonitorElement(DashboardControl parent,
		...
		new ConsoleJob(String.format("Subscribing to channel ",
				NXCSession.CHANNEL_EVENTS), viewPart, Activator.PLUGIN_ID, null) {
			@Override
	...
	public void dispose() {
		ConsoleJob job = new ConsoleJob(String.format(
				"Unsuscribing from channel ", NXCSession.CHANNEL_EVENTS), null,
