 ...
 */
public class IdMatchingLabelProvider extends LabelProvider implements
	...
	public Image getColumnImage(Object element, int columnIndex) {
		...
		if (element instanceof ObjectIdMatchingData)
			return imageCache
					.add(ObjectIcons
							.getObjectImageDescriptor(((ObjectIdMatchingData) element).objectClass));

		if (element instanceof DciIdMatchingData)
			return imageCache
					.add(Activator.getImageDescriptor("icons/dci.png")); //$NON-NLS-1$
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case IdMatchingDialog.COLUMN_DESTINATION_ID:
			...
			return (id > 0) ? Long.toString(id)
					: Messages.get().IdMatchingLabelProvider_NoMatch;
	...
	public Color getForeground(Object element) {
		return SharedColors.getColor((((IdMatchingData) element)
				.getDestinationId() != 0) ? SharedColors.TEXT_NORMAL
				: SharedColors.TEXT_ERROR, Display.getCurrent());
	}
