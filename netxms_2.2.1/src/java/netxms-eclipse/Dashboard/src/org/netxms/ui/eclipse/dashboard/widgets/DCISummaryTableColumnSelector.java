...
public class DCISummaryTableColumnSelector extends AbstractSelector {
	...
	public DCISummaryTableColumnSelector(Composite parent, int style,
			int options, String columnName, Table sourceTable,
	...
	protected void selectionButtonHandler() {
		...
		if (sourceSummaryTable != null) {
			List<DciSummaryTableColumn> column = sourceSummaryTable
					.getColumns();
		...
		TableColumnSelectionDialog dlg = new TableColumnSelectionDialog(
				getShell(), valuesArray);
