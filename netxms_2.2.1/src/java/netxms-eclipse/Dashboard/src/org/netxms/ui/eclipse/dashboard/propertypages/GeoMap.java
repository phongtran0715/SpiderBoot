...
public class GeoMap extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		zoom = WidgetHelper.createLabeledSpinner(dialogArea, SWT.BORDER,
				Messages.get().GeoMap_Zoom, 0, 18,
	...
	public boolean performOk() {
		try {
			GeoLocation center = GeoLocation.parseGeoLocation(
			...
			MessageDialogHelper.openError(getShell(),
					Messages.get().GeoMap_Error,
					Messages.get().GeoMap_ErrorText);
		}
