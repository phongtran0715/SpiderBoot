...
public class EmbeddedDashboardConfig extends DashboardElementConfig {
	 ...
	 */
	public static EmbeddedDashboardConfig createFromXml(final String xml)
			throws Exception {
		Serializer serializer = new Persister();
		EmbeddedDashboardConfig config = serializer.read(
				EmbeddedDashboardConfig.class, xml);
