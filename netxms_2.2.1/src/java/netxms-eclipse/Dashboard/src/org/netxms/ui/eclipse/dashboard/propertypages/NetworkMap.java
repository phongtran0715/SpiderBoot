...
public class NetworkMap extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		config = (NetworkMapConfig) getElement().getAdapter(
				NetworkMapConfig.class);
		...
		objectSelector
				.setObjectClass(org.netxms.client.objects.NetworkMap.class);
		...
		enableObjectDoubleClick
				.setText(Messages.get().NetworkMap_EnableDoubleClickAction);
