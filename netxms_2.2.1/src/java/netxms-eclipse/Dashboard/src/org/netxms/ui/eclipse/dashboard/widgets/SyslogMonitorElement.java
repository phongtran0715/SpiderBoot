...
public class SyslogMonitorElement extends ElementWidget {
	...
	protected SyslogMonitorElement(DashboardControl parent,
		...
		new ConsoleJob(String.format("Subscribing to channel ",
				NXCSession.CHANNEL_SYSLOG), viewPart, Activator.PLUGIN_ID, null) {
			@Override
	...
	public void dispose() {
		ConsoleJob job = new ConsoleJob(String.format(
				"Unsuscribing from channel ", NXCSession.CHANNEL_SYSLOG), null,
