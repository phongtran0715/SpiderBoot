...
public class DciSummaryTableElement extends ElementWidget {
	 ...
	 * @param data
	 */
	public DciSummaryTableElement(DashboardControl parent,
		...
		SummaryTableWidget viewer = new SummaryTableWidget(this, SWT.NONE,
				viewPart, config.getTableId(), config.getBaseObjectId());
