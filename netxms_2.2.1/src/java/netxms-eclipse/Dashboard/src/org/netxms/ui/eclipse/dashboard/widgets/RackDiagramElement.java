...
public class RackDiagramElement extends ElementWidget {
	 ...
	 *            viewPart
	 */
	protected RackDiagramElement(DashboardControl parent,
		...
		if (rack != null) {
			rackArea = new Composite(this, SWT.NONE) {
				...
				public Point computeSize(int wHint, int hHint, boolean changed) {
					...
					Point s = rackFrontWidget
							.computeSize(wHint, hHint, changed);
					return new Point(s.x * 2, s.y);
				}
			};
			rackArea.setBackground(SharedColors.getColor(
			...
			rackArea.addControlListener(new ControlAdapter() {
				...
				public void controlResized(ControlEvent e) {
					...
					Point size = rackFrontWidget.computeSize(SWT.DEFAULT,
							height, true);
			...
			setRackFrontWidget(new RackWidget(rackArea, SWT.NONE, rack,
					RackOrientation.FRONT));
			setRackRearWidget(new RackWidget(rackArea, SWT.NONE, rack,
