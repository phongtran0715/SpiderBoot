 ...
 */
public class DashboardsDynamicMenu extends ContributionItem implements
	...
	public void fill(Menu menu, int index) {
		...
		final AbstractObject object = (AbstractObject) ((IStructuredSelection) selection)
				.getFirstElement();
				...
				public void widgetSelected(SelectionEvent e) {
					...
					try {
						...
						MessageDialogHelper.openError(
								window.getShell(),
								Messages.get().OpenDashboard_Error,
								Messages.get().OpenDashboard_ErrorText
										+ ex.getMessage());
					}
				}
			});
		...
		dashboardsMenuItem
				.setText(Messages.get().DashboardsDynamicMenu_Dashboards);
