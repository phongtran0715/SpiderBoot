...
public class GaugeConfig extends AbstractChartConfig {
	...
	/**
	 * @param leftYellowZone
	 *            the leftYellowZone to set
	 */
	 ...
	 *            the elementBordersVisible to set
	 */
