...
public abstract class TableComparisonChartConfig extends DashboardElementConfig {
	...
	/**
	 * @param sortOnDataColumn
	 *            the sortOnDataColumn to set
	 */
	 ...
	 * @see
	 * org.netxms.ui.eclipse.dashboard.widgets.internal.DashboardElementConfig
	 * #remapDataCollectionItems(java.util.Map)
	 */
	@Override
