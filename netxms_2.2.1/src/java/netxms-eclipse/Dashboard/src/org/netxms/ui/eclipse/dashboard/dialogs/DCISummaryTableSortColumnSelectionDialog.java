...
public class DCISummaryTableSortColumnSelectionDialog extends Dialog {
	...
	public DCISummaryTableSortColumnSelectionDialog(Shell parentShell,
			String sortingColumn, boolean descSorting, int summaryTableId) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		new ConsoleJob("Get summary table configuration by id", null,
		...
		selector = new DCISummaryTableColumnSelector(dialogArea, SWT.NONE,
				AbstractSelector.SHOW_CLEAR_BUTTON, sortingColumn, null,
				sourceSummaryTable);
	...
	protected void okPressed() {
		...
		sortingColumn = (descSorting.getSelection() ? ">" : "<")
				+ selector.getColumnName();
		super.okPressed();
	}
