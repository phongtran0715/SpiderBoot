...
public class Messages extends NLS {
	private static final String BUNDLE_NAME = "org.netxms.ui.eclipse.spidermanager.messages"; //$NON-NLS-1$
	...
	public static String Authentication_LDAPPassword;
	...
	public static String CreateNewCertificateDialog_BrowseLabel;
	public static String CreateNewCertificateDialog_CertificateCommentLabel;
	public static String CreateNewCertificateDialog_CreateNewCertificateDialogTitle;
	...
	public static String EditCertificateDialog_EditCertificateDialogTitle;
	...
	public static String SystemRights_ManageAllScheduledTasks;
	public static String SystemRights_ManageDCISummaryTables;
	public static String SystemRights_ManageFiles;
	public static String SystemRights_ManageMappingTables;
	public static String SystemRights_ManageOwnScheduledTasks;
	...
	public static String SystemRights_ManageUserScheduledTasks;
	public static String SystemRights_ReadFiles;
	public static String SystemRights_RegisterAgents;
	public static String SystemRights_ReportingServerAccess;
	public static String SystemRights_ScheduleFileUploadTask;
	public static String SystemRights_ScheduleObjectMaint;
	public static String SystemRights_ScheduleScriptTask;
	public static String SystemRights_SendSMS;
	public static String SystemRights_UnlinkTicket;
	...
	public static String SystemRights_ViewSyslog;
	public static String SystemRights_ViewTrapLog;
	public static String UserLabelProvider_Certificate;
	public static String UserLabelProvider_CertificateOrPassword;
	public static String UserLabelProvider_CertificateOrRADIUS;
	public static String UserLabelProvider_Group;
	public static String UserLabelProvider_LDAP;
	public static String UserLabelProvider_Local;
	public static String UserLabelProvider_Password;
	public static String UserLabelProvider_RADIUS;
	public static String UserLabelProvider_Unknown;
	public static String UserLabelProvider_User;
	public static String UserManagementView_7;
	public static String UserManagementView_Authentication;
	...
	public static String UserManagementView_DetachError;
	public static String UserManagementView_DetachFromLDAP;
	public static String UserManagementView_Disable;
	public static String UserManagementView_DisableError;
	public static String UserManagementView_Enable;
	public static String UserManagementView_EnableError;
	...
	public static String UserManagementView_Source;
