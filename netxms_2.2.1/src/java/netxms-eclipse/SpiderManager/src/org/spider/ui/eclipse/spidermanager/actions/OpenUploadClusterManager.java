...
import org.spider.ui.eclipse.spidermanager.views.UploadClusterManagerView;
import org.netxms.ui.eclipse.tools.MessageDialogHelper;

public class OpenUploadClusterManager implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		...
		if (window != null) {
			try {
				window.getActivePage().showView(UploadClusterManagerView.ID);
