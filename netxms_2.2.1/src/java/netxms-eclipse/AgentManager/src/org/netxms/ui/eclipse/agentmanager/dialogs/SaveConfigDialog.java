...
public class SaveConfigDialog extends Dialog {
	...
	protected void createButtonsForButtonBar(Composite parent) {
		createButton(parent, SAVE_ID, Messages.get().SaveConfigDialog_Save,
				false);
		createButton(parent, SAVE_AND_APPLY_ID,
				Messages.get().SaveConfigDialog_SaveApply, false);
		createButton(parent, DISCARD_ID,
				Messages.get().SaveConfigDialog_Discard, false);
		createButton(parent, IDialogConstants.CANCEL_ID,
				Messages.get().SaveConfigDialog_Cancel, false);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		image.setImage(Activator
				.getImageDescriptor("icons/unsaved_config.png").createImage()); //$NON-NLS-1$
