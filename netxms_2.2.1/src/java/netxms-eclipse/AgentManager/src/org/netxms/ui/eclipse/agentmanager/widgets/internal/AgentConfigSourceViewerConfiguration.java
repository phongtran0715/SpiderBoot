 ...
 */
public class AgentConfigSourceViewerConfiguration extends
	...
	private static final String[] configKeywords = { "Action", //$NON-NLS-1$
	...
	private static final IRule[] codeRules = { new KeywordRule(
			configWordDetector,
			AgentConfigTextAttributeProvider
					.getTextAttributeToken(AgentConfigTextAttributeProvider.KEYWORD),
			AgentConfigTextAttributeProvider
					.getTextAttributeToken(AgentConfigTextAttributeProvider.DEFAULT),
			configKeywords) };
	...
	public IPresentationReconciler getPresentationReconciler(
		...
		scanner.setDefaultReturnToken(AgentConfigTextAttributeProvider
				.getTextAttributeToken(AgentConfigTextAttributeProvider.DEFAULT));
		...
		dr = new DefaultDamagerRepairer(
				new SingleTokenScanner(
						AgentConfigTextAttributeProvider
								.getTextAttribute(AgentConfigTextAttributeProvider.COMMENT)));
		...
		dr = new DefaultDamagerRepairer(
				new SingleTokenScanner(
						AgentConfigTextAttributeProvider
								.getTextAttribute(AgentConfigTextAttributeProvider.SECTION)));
		...
		scanner.setDefaultReturnToken(AgentConfigTextAttributeProvider
				.getTextAttributeToken(AgentConfigTextAttributeProvider.STRING));
