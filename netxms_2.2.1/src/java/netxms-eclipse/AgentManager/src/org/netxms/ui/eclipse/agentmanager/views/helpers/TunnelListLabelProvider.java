 ...
 */
public class TunnelListLabelProvider extends LabelProvider implements
		ITableLabelProvider, IColorProvider {
	private static final Color COLOR_BOUND = new Color(Display.getDefault(),
			new RGB(26, 88, 0));
	private static final Color COLOR_UNBOUND = new Color(Display.getDefault(),
			new RGB(199, 83, 0));
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case TunnelManager.COL_NODE:
			return t.isBound() ? ConsoleSharedData.getSession().getObjectName(
					t.getNodeId()) : "";
