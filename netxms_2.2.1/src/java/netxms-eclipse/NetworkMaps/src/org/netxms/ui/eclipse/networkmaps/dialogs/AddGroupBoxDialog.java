...
public class AddGroupBoxDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		spinnerWidth = (Spinner) WidgetHelper.createLabeledControl(attrArea,
				SWT.NONE, factory, Messages.get().AddGroupBoxDialog_Width,
				WidgetHelper.DEFAULT_LAYOUT_DATA);
		spinnerWidth.setSelection(250);
		spinnerHeight = (Spinner) WidgetHelper.createLabeledControl(attrArea,
				SWT.NONE, factory, Messages.get().AddGroupBoxDialog_Height,
				WidgetHelper.DEFAULT_LAYOUT_DATA);
		spinnerHeight.setSelection(100);

		colorSelector = WidgetHelper.createLabeledColorSelector(attrArea,
				Messages.get().AddGroupBoxDialog_Color,
				WidgetHelper.DEFAULT_LAYOUT_DATA);
