...
public class LinkEditor {
	...
	public void update() {
		...
		link = new NetworkMapLink(name, type, link.getElement1(),
				link.getElement2(), connectorName1, connectorName2,
				dciList.toArray(new SingleDciConfig[dciList.size()]),
				link.getFlags());
		link.setColor(color);
	...
	/**
	 * @param id
	 *            the id of status object to be added
	 */
	...
	/**
	 * @param index
	 *            the index of status the object to be removed
	 */
	...
	public long getObject1() {
		NetworkMapObject e = (NetworkMapObject) mapPage.getElement(
				link.getElement1(), NetworkMapObject.class);
	...
	public long getObject2() {
		NetworkMapObject e = (NetworkMapObject) mapPage.getElement(
				link.getElement2(), NetworkMapObject.class);
		return (e != null) ? e.getObjectId() : 0;
	}
