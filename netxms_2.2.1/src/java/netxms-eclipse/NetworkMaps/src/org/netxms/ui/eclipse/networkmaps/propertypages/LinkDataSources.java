...
public class LinkDataSources extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		final String[] columnNames = { Messages.get().LinkDataSources_ColPos,
				Messages.get().LinkDataSources_ColNode,
				Messages.get().LinkDataSources_ColParameter,
				Messages.get().LinkDataSources_ColName };
