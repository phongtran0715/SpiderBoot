...
public class ObjectFigureLargeLabel extends ObjectFigure {
	 ...
	 * @param labelProvider
	 */
	public ObjectFigureLargeLabel(NetworkMapObject element,
		...
		if ((object instanceof Node)
				&& ((Node) object).getPrimaryIP().isValidAddress()
				&& !((Node) object).getPrimaryIP().getAddress()
						.isAnyLocalAddress()) {
		...
		if (object instanceof Node) {
			DciValue[] values = labelProvider.getNodeLastValues(object
					.getObjectId());
