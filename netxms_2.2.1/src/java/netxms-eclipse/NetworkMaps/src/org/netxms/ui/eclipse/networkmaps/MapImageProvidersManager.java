...
/**
 * Manager of network map image providers. There should be only one instance of
 * it, created early during console startup.
 */
public class MapImageProvidersManager {
	...
	private MapImageProvidersManager() {
		...
		IConfigurationElement[] elements = reg
				.getConfigurationElementsFor("org.netxms.ui.eclipse.networkmaps.imageproviders"); //$NON-NLS-1$
		for (int i = 0; i < elements.length; i++) {
			try {
				final NetworkMapImageProvider p = (NetworkMapImageProvider) elements[i]
