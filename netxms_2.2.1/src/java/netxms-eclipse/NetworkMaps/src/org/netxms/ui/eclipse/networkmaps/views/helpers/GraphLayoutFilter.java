...
/**
 * Custom graph layout filter which prevents decoration elements from being
 * included into layout
 * 
 */
public class GraphLayoutFilter implements LayoutFilter {
	 ...
	 * 
	 * @see
	 * org.eclipse.gef4.zest.core.widgets.LayoutFilter#isObjectFiltered(org.
	 * eclipse.gef4.zest.core.widgets.GraphItem)
	 */
	@Override
		...
		if (item instanceof GraphNode) {
			if (filterDecoration)
				return (item.getData() instanceof NetworkMapDecoration
						|| item.getData() instanceof NetworkMapDCIContainer
						|| item.getData() instanceof NetworkMapDCIImage || item
							.getData() instanceof NetworkMapTextBox);
			else
				return !(item.getData() instanceof NetworkMapDecoration
						|| item.getData() instanceof NetworkMapDCIContainer
						|| item.getData() instanceof NetworkMapDCIImage || item
