...
public class Layer2Topology extends AbstractNetworkMapView {
	...
	public void init(IViewSite site) throws PartInitException {
		super.init(site);
		setPartName(Messages.get().Layer2Topology_PartTitle
	...
	protected void buildMapPage() {
		...
		new ConsoleJob(String.format(Messages.get().Layer2Topology_JobTitle,
				rootObject.getObjectName()), this, Activator.PLUGIN_ID,
				Activator.PLUGIN_ID) {
			@Override
			protected void runInternal(IProgressMonitor monitor)
					throws Exception {
				NetworkMapPage page = session.queryLayer2Topology(rootObject
						.getObjectId());
			...
			protected String getErrorMessage() {
				return String.format(Messages.get().Layer2Topology_JobError,
						rootObject.getObjectName());
			}
		}.start();
	}
