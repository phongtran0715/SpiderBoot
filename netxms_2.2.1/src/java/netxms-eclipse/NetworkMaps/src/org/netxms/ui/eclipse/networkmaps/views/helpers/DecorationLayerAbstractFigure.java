 ...
 */
public abstract class DecorationLayerAbstractFigure extends Figure implements
		MouseListener, MouseMotionListener, IDecorationFigure {
	 ...
	 * @param labelProvider
	 */
	public DecorationLayerAbstractFigure(NetworkMapElement decoration,
			ExtendedGraphViewer viewer) {
	...
	public void mousePressed(MouseEvent me) {
		if (!selected) {
			viewer.setDecorationSelection(decoration,
					(me.button == 1) && ((me.getState() & SWT.MOD1) != 0));
			setSelected(true);
		}
