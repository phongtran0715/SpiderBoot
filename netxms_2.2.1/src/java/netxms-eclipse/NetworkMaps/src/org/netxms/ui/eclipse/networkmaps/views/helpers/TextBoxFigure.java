...
public class TextBoxFigure extends DecorationLayerAbstractFigure {
	 ...
	 * @param viewer
	 */
	public TextBoxFigure(NetworkMapTextBox decoration,
		...
		text.setFont(new Font(Display.getCurrent(), "Verdana", textBoxElement
				.getFontSize(), SWT.NONE));
		...
		text.setForegroundColor(labelProvider.getColors().create(
				ColorConverter.rgbFromInt(textBoxElement.getTextColor())));
	}
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.networkmaps.views.helpers.DecorationLayerAbstractFigure
	...
	protected void paintFigure(Graphics gc) {
		...
		gc.setBackgroundColor(labelProvider.getColors().create(
				ColorConverter.rgbFromInt(textBoxElement.getBackgroundColor())));
		...
		if (textBoxElement.isBorderRequired()) {
			...
			gc.setForegroundColor(labelProvider.getColors().create(
					ColorConverter.rgbFromInt(textBoxElement.getBorderColor())));
