 ...
 */
public class ClusterResourceListLabelProvider extends LabelProvider implements
		ITableLabelProvider {
	...
	public Image getColumnImage(Object element, int columnIndex) {
		if (columnIndex == 0)
			return StatusDisplayInfo
					.getStatusImage((((ClusterResource) element)
							.getCurrentOwner() != 0) ? Severity.NORMAL
							: Severity.MAJOR);
		return null;
	}
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case ClusterTab.COLUMN_VIP:
			return ((ClusterResource) element).getVirtualAddress()
					.getHostAddress();
		case ClusterTab.COLUMN_OWNER:
			...
			if (ownerId > 0) {
				...
				return (owner != null) ? owner.getObjectName()
						: "<" + Long.toString(ownerId) + ">"; //$NON-NLS-1$ //$NON-NLS-2$
			} else {
