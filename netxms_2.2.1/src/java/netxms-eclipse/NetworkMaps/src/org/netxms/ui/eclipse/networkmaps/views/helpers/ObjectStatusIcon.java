...
public class ObjectStatusIcon extends ObjectFigure {
	 ...
	 * Constructor
	 */
	public ObjectStatusIcon(NetworkMapObject element,
	...
	private void updateSize(MapLabelProvider labelProvider) {
		...
		setSize(imageWidth + BACKGROUND_MARGIN_X * 2 + FRAME_LINE_WIDTH,
				imageHeight + IMAGE_MARGIN_Y * 2 + FRAME_LINE_WIDTH);
	}
