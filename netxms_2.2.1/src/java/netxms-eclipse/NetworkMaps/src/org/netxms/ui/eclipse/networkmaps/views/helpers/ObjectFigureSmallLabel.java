...
public class ObjectFigureSmallLabel extends ObjectFigure {
	 ...
	 * @param labelProvider
	 */
	public ObjectFigureSmallLabel(NetworkMapObject element,
		...
		setOpaque(true);
		setBackgroundColor(SharedColors.getColor(
				SharedColors.MAP_SMALL_LABEL_BACKGROUND, Display.getCurrent()));
	...
	private void updateSize() {
		...
		setSize(ls.width + MARGIN_WIDTH * 2 + BORDER_WIDTH * 2, ls.height
				+ MARGIN_HEIGHT * 2 + BORDER_WIDTH * 2);
	}
	...
	protected void paintFigure(Graphics gc) {
		...
		gc.setForegroundColor(isElementSelected() ? SELECTION_COLOR
				: StatusDisplayInfo.getStatusColor(object.getStatus()));
