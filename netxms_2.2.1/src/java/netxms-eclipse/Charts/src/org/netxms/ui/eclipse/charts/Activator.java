...
public class Activator extends AbstractUIPlugin {
	...
	private static final String[] CHART_FONTS = {
			"Segoe UI", "DejaVu Sans", "Lucida Sans", "Arial", "Helvetica" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
	...
	public void start(BundleContext context) throws Exception {
		...
		service.registerIconForFamily(
				getImageDescriptor("icons/graph.png"), Activator.PLUGIN_ID); //$NON-NLS-1$
	}
