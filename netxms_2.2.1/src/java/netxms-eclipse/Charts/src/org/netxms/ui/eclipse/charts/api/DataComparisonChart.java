...
public interface DataComparisonChart extends DataChart {
	 ...
	 * 
	 * @param index
	 *            parameter's index (0 .. MAX_CHART_ITEMS-1)
	 * @param value
	 *            parameter's value
	 * @param updateChart
	 *            if tru, chart will be updated (repainted)
	 */
	public abstract void updateParameter(int index, double value,
			boolean updateChart);
	 ...
	 *            DCI data type
	 * @param updateChart
	 *            if true, chart will be updated (repainted)
	 */
	public abstract void updateParameter(int index, DciDataRow value,
			int dataType, boolean updateChart);
	 ...
	 *            new thresholds
	 */
	public abstract void updateParameterThresholds(int index,
	 ...
	 * 
	 * @param visible
	 *            true to make data labels visible
	 */
