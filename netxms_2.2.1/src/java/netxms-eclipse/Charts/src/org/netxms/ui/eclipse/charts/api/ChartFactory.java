...
public class ChartFactory {
	 ...
	 */
	public static HistoricalDataChart createLineChart(Composite parent,
			int style) {
	...
	public static DataComparisonChart createBarChart(Composite parent, int style) {
		return new DataComparisonBirtChart(parent, style,
				DataComparisonChart.BAR_CHART);
	}
	 ...
	 */
	public static DataComparisonChart createTubeChart(Composite parent,
			int style) {
		return new DataComparisonBirtChart(parent, style,
				DataComparisonChart.TUBE_CHART);
	}
