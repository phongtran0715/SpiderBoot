 ...
 */
public abstract class GaugeWidget extends GenericChart implements Gauge,
	...
	protected List<DataComparisonElement> parameters = new ArrayList<DataComparisonElement>(
			MAX_CHART_ITEMS);
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.charts.api.DataChart#setChartTitle(java.lang.String
	 * )
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.charts.api.DataComparisonChart#addParameter(org
	 * .netxms.client.datacollection.GraphItem, double)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.netxms.ui.eclipse.charts.api.DataComparisonChart#
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.charts.api.DataComparisonChart#setChartType(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.charts.api.DataComparisonChart#setTransposed(boolean
	 * )
	 */
	@Override
	...
	private void render() {
		...
		if ((parameters.size() == 0) || (size.x < OUTER_MARGIN_WIDTH * 2)
				|| (size.y < OUTER_MARGIN_HEIGHT * 2)) {
			gc.dispose();
			return;
		}
	 ...
	 * @param w
	 */
	protected abstract void renderElement(GC gc, DataComparisonElement dci,
	...
	protected String getValueAsDisplayString(DataComparisonElement dci) {
		return new DataFormatter(dci.getDisplayFormat(), dci.getObject()
				.getDataType()).format(dci.getRawValue());
	}
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.charts.api.DialChart#setRightYellowZone(double)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.charts.api.Gauge#setElementBordersVisible(boolean)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.charts.api.Gauge#setGaugeColorMode(org.netxms.ui
	 * .eclipse.charts.api.GaugeColorMode)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.charts.api.Gauge#setCustomColor(org.eclipse.swt
	 * .graphics.RGB)
	 */
	@Override
