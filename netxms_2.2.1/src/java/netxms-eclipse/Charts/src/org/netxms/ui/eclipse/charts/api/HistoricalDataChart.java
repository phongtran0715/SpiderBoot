...
public interface HistoricalDataChart extends DataChart {
	 ...
	 */
	public abstract void updateParameter(int index, DciData data,
			boolean updateChart);
	 ...
	 * 
	 * @param repaint
	 *            if true, chart will be repainted after change
	 */
	 ...
	 * 
	 * @param modifyYBase
	 *            true to use min DCI value as Y base
	 */
