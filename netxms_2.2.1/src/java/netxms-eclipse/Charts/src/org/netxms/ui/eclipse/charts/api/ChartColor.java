...
public final class ChartColor {
	...
	/**
	 * Create color object from separate R, G, B values. Alpha value set to 255
	 * (opaque).
	 * 
	 * @param red
	 * @param green
	...
	/**
	 * Create color object from 32bit integer containing RGB value (high-order
	 * byte ignored).
	 * 
	 * @param rgb
	 *            RGB value encoded as 32bit integer
	 */
	...
	/**
	 * Create RGBA value encoded into 32bit integer, with alpha value in
	 * high-order byte.
	 * 
	 ...
	 */
	public static ChartColor createFromPreferences(
			IPreferenceStore preferenceStore, String name) {
	...
	public static ChartColor getDefaultColor(int index) {
		return new ChartColor(PreferenceConverter.getColor(Activator
				.getDefault().getPreferenceStore(),
				"Chart.Colors.Data." + index)); //$NON-NLS-1$
	}
}
