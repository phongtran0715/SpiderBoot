...
public interface DataChart {
	 ...
	 * 
	 * @param from
	 *            minimal y axis number
	 * @param to
	 *            maximal y axis number
	 */
	 ...
	 * 
	 * @param visible
	 *            true to show title, false to hide
	 */
	 ...
	 * 
	 * @param visible
	 *            true to show grid, false to hide
	 */
	 ...
	 * 
	 * @param enabled
	 *            true to enable logarithmic scale mode
	 */
	 ...
	 * 
	 * @param translucent
	 *            tru to set chart data translucent
	 */
	 ...
	 * @param background
	 */
	public abstract void setLegendColor(ChartColor foreground,
	...
	/**
	 * Add information about error. Chart implementation should display error
	 * notification in some way.
	 * 
	 * @param message
	 *            error message
	 */
