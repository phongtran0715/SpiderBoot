...
public class ServiceTree extends Composite implements IServiceFigureListener {
	...
	public ServiceTree(Composite parent, int style, AbstractObject rootObject) {
		...
		// TreeLayoutAlgorithm mainLayoutAlgorithm = new
		// TreeLayoutAlgorithm(TreeLayoutAlgorithm.TOP_DOWN);
		/*
		 * mainLayoutAlgorithm.setComparator(new Comparator() {
		 * 
		 * @Override public int compare(Object arg0, Object arg1) { return
		 * arg0.toString().compareToIgnoreCase(arg1.toString()); } });
		 */
		// viewer.setLayoutAlgorithm(new CompositeLayoutAlgorithm(new
		// LayoutAlgorithm[] { mainLayoutAlgorithm, new SparseTree() }));
		viewer.setLayoutAlgorithm(new SpaceTreeLayoutAlgorithm(
				SpaceTreeLayoutAlgorithm.TOP_DOWN, false));
	 ...
	 * 
	 * @see
	 * org.netxms.ui.eclipse.serviceview.widgets.helpers.IServiceFigureListener
	 * #expandButtonPressed
	 * (org.netxms.ui.eclipse.serviceview.widgets.helpers.ServiceTreeElement)
	 */
	@Override
