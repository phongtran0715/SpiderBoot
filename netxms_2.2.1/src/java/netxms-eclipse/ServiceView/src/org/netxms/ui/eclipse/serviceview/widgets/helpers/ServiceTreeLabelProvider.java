...
public class ServiceTreeLabelProvider extends LabelProvider implements
	 ...
	 */
	public ServiceTreeLabelProvider(GraphViewer viewer,
			IServiceFigureListener figureListener) {
		this.viewer = viewer;
		...
		collapsedIcon = Activator
				.getImageDescriptor("icons/collapsed.png").createImage(); //$NON-NLS-1$
		expandedIcon = Activator
				.getImageDescriptor("icons/expanded.png").createImage(); //$NON-NLS-1$
	}
	...
	public Image getImage(Object element) {
		if (element instanceof ServiceTreeElement)
			return workbenchLabelProvider
					.getImage(((ServiceTreeElement) element).getObject());
		return null;
	}
	...
	public IFigure getFigure(Object element) {
		return new ServiceFigure((ServiceTreeElement) element, this,
				figureListener);
	}
	...
	public Image getExpansionStatusIcon(ServiceTreeElement element) {
		return element.hasChildren() ? (element.isExpanded() ? expandedIcon
				: collapsedIcon) : null;
	}
