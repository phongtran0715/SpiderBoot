...
/**
 * Simple image cache which takes care of image destruction when associated
 * control disposed
 */
public class ImageCache implements DisposeListener {
	...
	/**
	 * Create unassociated image cache. It must be disposed explicitly by
	 * calling dispose().
	 */
	public ImageCache() {
	}
	...
	/**
	 * Create image cache associated with given control. All images in a cache
	 * will be disposed when associatet control gets disposed.
	 * 
	 * @param control
	 *            control
	 */
