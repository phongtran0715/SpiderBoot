...
public class SplashHandler extends BasicSplashHandler {
	...
	public void init(Shell splash) {
		...
		final Color versionColor = new Color(Display.getCurrent(), 224, 224,
				224);
		final Font versionFont = new Font(Display.getCurrent(),
				"Verdana", 9, SWT.NONE); //$NON-NLS-1$
		final String versionText = Messages.get().SplashHandler_Version
				+ NXCommon.VERSION + " (" + BuildNumber.TEXT + ")"; //$NON-NLS-1$ //$NON-NLS-2$
