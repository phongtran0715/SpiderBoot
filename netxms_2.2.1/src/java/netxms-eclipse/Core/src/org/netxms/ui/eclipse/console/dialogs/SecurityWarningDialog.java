...
public class SecurityWarningDialog extends Dialog {
	 ...
	 */
	public static int showSecurityWarning(Shell parentShell, String message,
			String details) {
		SecurityWarningDialog dlg = new SecurityWarningDialog(parentShell,
				message, details);
	 ...
	 * @param details
	 */
	protected SecurityWarningDialog(Shell parentShell, String message,
			String details) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		icon.setImage(Activator
				.getImageDescriptor("icons/security-warning.png").createImage()); //$NON-NLS-1$
		...
		checkDontAskAgain
				.setText(Messages.get().SecurityWarningDialog_DontAskAgain);
