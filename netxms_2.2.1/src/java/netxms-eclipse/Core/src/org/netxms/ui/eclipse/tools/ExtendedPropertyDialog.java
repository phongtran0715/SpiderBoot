...
public class ExtendedPropertyDialog extends PropertyDialog {
	 ...
	 * @param selection
	 */
	public ExtendedPropertyDialog(Shell parentShell, PreferenceManager mng,
	...
	public void createAllPages() {
		List<?> nodes = getPreferenceManager().getElements(
	 ...
	 * @return
	 */
	public static ExtendedPropertyDialog createDialogOn(Shell shell,
		...
		ExtendedPropertyDialog propertyDialog = new ExtendedPropertyDialog(
				shell, pageManager, new StructuredSelection(element));
