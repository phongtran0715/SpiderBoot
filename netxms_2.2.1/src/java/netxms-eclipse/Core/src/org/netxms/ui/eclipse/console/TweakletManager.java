...
public class TweakletManager {
	...
	static void initTweaklets() {
		...
		IConfigurationElement[] elements = reg
				.getConfigurationElementsFor("org.netxms.ui.eclipse.tweaklets"); //$NON-NLS-1$
		for (int i = 0; i < elements.length; i++) {
			try {
				final ConsoleTweaklet t = (ConsoleTweaklet) elements[i]
	...
	/**
	 * Call postLogin() method for all tweaklets. This method called from login
	 * thread, while UI is blocked in wait dialog.
	 * 
	 * @param monitor
	 */
