...
public class MessageDialogHelper {
	 ...
	 *            , {@link MessageDialog#INFORMATION},
	 *            {@link MessageDialog#QUESTION}, {@link MessageDialog#WARNING},
	 *            {@link MessageDialog#CONFIRM}, or
	...
	/**
	 * Convenience method to open a simple confirm (OK/Cancel) dialog with a
	 * check box to remember selection.
	 * 
	 * @param parent
	 *            the parent shell of the dialog, or <code>null</code> if none
	 * @param title
	 ...
	 * @return
	 */
	public static DialogData openConfirmWithCheckbox(Shell parent,
			String title, String label, String message) {
		MessageDialogWithCheckbox msg = new MessageDialogWithCheckbox(
				MessageDialog.CONFIRM, new String[] {
						IDialogConstants.OK_LABEL,
						IDialogConstants.CANCEL_LABEL }, parent, title, label,
				message);
		return msg.openMsg();
	}
	...
	/**
	 * Convenience method to open a standard warning dialog with a check box to
	 * remember selection.
	 * 
	 * @param parent
	 *            the parent shell of the dialog, or <code>null</code> if none
	 ...
	 * @return
	 */
	public static DialogData openWarningWithCheckbox(Shell parent,
			String title, String label, String message) {
		MessageDialogWithCheckbox msg = new MessageDialogWithCheckbox(
	...
	/**
	 * Convenience method to open a standard one button (OK) warning dialog with
	 * a check box to remember selection.
	 * 
	 * @param parent
	 *            the parent shell of the dialog, or <code>null</code> if none
	 * @param title
	 ...
	 * @return
	 */
	public static DialogData openOneButtonWarningWithCheckbox(Shell parent,
			String title, String label, String message) {
		MessageDialogWithCheckbox msg = new MessageDialogWithCheckbox(
				MessageDialog.WARNING,
				new String[] { IDialogConstants.OK_LABEL }, parent, title,
				label, message);
		return msg.openMsg();
	}

	/**
	 * Helper class to show message dialog with check box (for example to add
	...
	private static class MessageDialogWithCheckbox extends MessageDialog {
		...
		public MessageDialogWithCheckbox(int kind, String[] buttonLabels,
				Shell parent, String title, String label, String message) {
