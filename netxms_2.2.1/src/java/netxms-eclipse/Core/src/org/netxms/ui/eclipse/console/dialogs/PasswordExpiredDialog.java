...
public class PasswordExpiredDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		msg.setText(String.format(
				Messages.get().PasswordExpiredDialog_passwd_expired,
				graceLogins)); //$NON-NLS-1$
		gd = new GridData();
		...
		textPassword1 = WidgetHelper.createLabeledText(editArea, SWT.SINGLE
				...
				Messages.get().PasswordExpiredDialog_new_passwd,
				"", WidgetHelper.DEFAULT_LAYOUT_DATA); //$NON-NLS-1$ //$NON-NLS-2$
		textPassword2 = WidgetHelper.createLabeledText(editArea, SWT.SINGLE
				| SWT.BORDER | SWT.PASSWORD, SWT.DEFAULT,
				Messages.get().PasswordExpiredDialog_confirm_passwd,
				"", WidgetHelper.DEFAULT_LAYOUT_DATA); //$NON-NLS-1$ //$NON-NLS-2$
