...
public class SharedColors {
	...
	static {
		...
		defaultColors.put(MIB_EXPLORER_HEADER_BACKGROUND,
				new RGB(153, 180, 209));
		...
		defaultColors.put(RULE_EDITOR_NORMAL_TITLE_BACKGROUND, new RGB(225,
				233, 241));
		defaultColors.put(RULE_EDITOR_DISABLED_TITLE_BACKGROUND, new RGB(202,
				227, 206));
		defaultColors.put(RULE_EDITOR_SELECTED_TITLE_BACKGROUND, new RGB(245,
				249, 104));
