...
/**
 * Color manager. There should be only one instance of color manager, created
 * early during console startup.
 */
public class ColorManager {
	...
	private ColorManager() {
		...
		IConfigurationElement[] elements = reg
				.getConfigurationElementsFor("org.netxms.ui.eclipse.colorproviders"); //$NON-NLS-1$
		for (int i = 0; i < elements.length; i++) {
			try {
				final ColorProvider p = (ColorProvider) elements[i]
