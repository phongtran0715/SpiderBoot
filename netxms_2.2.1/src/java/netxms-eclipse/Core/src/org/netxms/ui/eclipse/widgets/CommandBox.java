...
public class CommandBox extends Composite implements DisposeListener {
	...
	public CommandBox(Composite parent, int style) {
		...
		setBackground(SharedColors.getColor(
				SharedColors.COMMAND_BOX_BACKGROUND, getDisplay()));
	...
	public void rebuild() {
		...
		for (final Action a : actions) {
			...
			label.setForeground(SharedColors.getColor(
					SharedColors.COMMAND_BOX_TEXT, getDisplay()));
	 ...
	 *            action
	 * @param doRebuild
	 *            if set to true, rebuild() will be called
	 */
