...
public class ApplicationPresentationFactory extends
		WorkbenchPresentationFactory {
	/*
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.ui.presentations.WorkbenchPresentationFactory#
	...
	public StackPresentation createViewPresentation(Composite parent,
		...
		TabbedStackPresentation p = (TabbedStackPresentation) super
				.createViewPresentation(parent, site);
