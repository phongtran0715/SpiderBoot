...
public class ServerNameStatusLineItem extends ContributionItem {
	...
	public void fill(Composite parent) {
		...
		label = new CLabel(statusLine, SWT.BORDER | SWT.SHADOW_ETCHED_IN
				| SWT.CENTER);
		label.setFont(font);
	...
	public void setServerInfo(String name, String color) {
		serverName = name;
		serverColor = (color != null) ? ColorConverter
				.parseColorDefinition(color) : null;
	...
	private void setColors() {
		if (bgColor != null)
			bgColor.dispose();
		bgColor = (serverColor != null) ? new Color(Display.getCurrent(),
				serverColor) : null;
