...
public class ApplicationWorkbenchAdvisor extends WorkbenchAdvisor {
	...
	public String getInitialWindowPerspectiveId() {
		...
		return Activator.getDefault().getPreferenceStore()
				.getString("INITIAL_PERSPECTIVE"); //$NON-NLS-1$
	}
	 ...
	 * 
	 * @see
	 * org.eclipse.ui.application.WorkbenchAdvisor#getComparatorFor(java.lang
	 * .String)
	 */
	@Override
		...
		shell.addShellListener(new ShellAdapter() {
			public void shellIconified(ShellEvent e) {
				if (Activator.getDefault().getPreferenceStore()
						.getBoolean("HIDE_WHEN_MINIMIZED")) //$NON-NLS-1$
				...
				if ((n.getCode() == SessionNotification.CONNECTION_BROKEN)
					...
					PlatformUI.getWorkbench().getDisplay()
							.asyncExec(new Runnable() {
								@Override
								public void run() {
									String productName = BrandingManager
									...
									MessageDialog.openError(
											...
											((n.getCode() == SessionNotification.CONNECTION_BROKEN) ? String.format(
													Messages.get().ApplicationWorkbenchAdvisor_ConnectionLostMessage,
													productName)
													: ((n.getCode() == SessionNotification.SESSION_KILLED) ? Messages
															.get().ApplicationWorkbenchAdvisor_SessionTerminated
															: String.format(
