...
public interface BrandingProvider {
	...
	/**
	 * Get default perspective. Should return null to use default (or defined by
	 * another branding manager)
	 * 
	 ...
	 * 
	 * @return image descriptor for image to be displayed in login dialog or
	 *         null to use default
	 */
