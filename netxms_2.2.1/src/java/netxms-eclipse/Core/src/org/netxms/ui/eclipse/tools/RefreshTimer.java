...
/**
 * Refresh timer helper class - calls given runnable on demand, but not often
 * then configured time period.
 */
public class RefreshTimer {
	 ...
	 * 
	 * @param interval
	 *            minimal interval between executions (in milliseconds)
	 * @param control
	 *            control to check for disposal
	 * @param callback
	 *            callback to run
	 */
	...
	/**
	 * Execute runnable if possible. If last execution was later than current
	 * time minus interval, runnable execution will be delayed. Multiple delayed
	 * execution requests will be reduced into one.
	 */
