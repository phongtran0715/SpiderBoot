...
public final class StatusDisplayInfo {
	...
	/**
	 * Initialize static members. Intended to be called once by library
	 * activator.
	 */
	public static void init(Display display) {
		...
		statusImageDesc[ObjectStatus.NORMAL.getValue()] = Activator
				.getImageDescriptor("icons/status/normal.png"); //$NON-NLS-1$
		statusImageDesc[ObjectStatus.WARNING.getValue()] = Activator
				.getImageDescriptor("icons/status/warning.png"); //$NON-NLS-1$
		statusImageDesc[ObjectStatus.MINOR.getValue()] = Activator
				.getImageDescriptor("icons/status/minor.png"); //$NON-NLS-1$
		statusImageDesc[ObjectStatus.MAJOR.getValue()] = Activator
				.getImageDescriptor("icons/status/major.png"); //$NON-NLS-1$
		statusImageDesc[ObjectStatus.CRITICAL.getValue()] = Activator
				.getImageDescriptor("icons/status/critical.png"); //$NON-NLS-1$
		statusImageDesc[ObjectStatus.UNKNOWN.getValue()] = Activator
				.getImageDescriptor("icons/status/unknown.png"); //$NON-NLS-1$
		statusImageDesc[ObjectStatus.UNMANAGED.getValue()] = Activator
				.getImageDescriptor("icons/status/unmanaged.png"); //$NON-NLS-1$
		statusImageDesc[ObjectStatus.DISABLED.getValue()] = Activator
				.getImageDescriptor("icons/status/disabled.png"); //$NON-NLS-1$
		statusImageDesc[ObjectStatus.TESTING.getValue()] = Activator
				.getImageDescriptor("icons/status/testing.png"); //$NON-NLS-1$
	...
	/**
	 * Get image for given status/severity code. Image is owned by library and
	 * should not be disposed by caller.
	 * 
	 * @param status
	 *            Status code
	 * @return Image descriptor for given code
	...
	public static Color getStatusColor(ObjectStatus status) {
		return SharedColors.getColor(statusColor[status.getValue()],
				Display.getCurrent());
	}
	...
	public static Color getStatusColor(Severity severity) {
		return SharedColors.getColor(statusColor[severity.getValue()],
				Display.getCurrent());
	}
