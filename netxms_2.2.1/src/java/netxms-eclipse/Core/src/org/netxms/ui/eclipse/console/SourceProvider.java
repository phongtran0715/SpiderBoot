...
public class SourceProvider extends AbstractSourceProvider {
	...
	private static final String[] PROVIDED_SOURCE_NAMES = {
			UA_ALL_SCHEDULED_TASKS, UA_CONFIGURE_TRAPS, UA_DELETE_ALARMS,
			UA_EDIT_EVENT_DB, UA_EPP, UA_MANAGE_ACTIONS, UA_MANAGE_AGENT_CFG,
			UA_MANAGE_SERVER_FILES, UA_MANAGE_IMAGE_LIB,
			UA_MANAGE_MAPPING_TBLS, UA_MANAGE_PACKAGES, UA_MANAGE_SCRIPTS,
			UA_MANAGE_SESSIONS, UA_MANAGE_PSTORAGE, UA_MANAGE_SUMMARY_TBLS,
			UA_MANAGE_TOOLS, UA_MANAGE_USERS, UA_MOBILE_DEVICE_LOGIN,
			UA_OWN_SCHEDULED_TASKS, UA_READ_SERVER_FILES, UA_REGISTER_AGENTS,
			UA_REPORTING_SERVER, UA_SCHEDULE_FILE_UPLOAD,
			UA_SCHEDULE_MAINTENANCE, UA_SCHEDULE_SCRIPT, UA_SEND_SMS,
			UA_SERVER_CONFIG, UA_SERVER_CONSOLE, UA_UNLINK_ISSUES,
			UA_USER_SCHEDULED_TASKS, UA_VIEW_AUDIT_LOG, UA_VIEW_EVENT_DB,
			UA_VIEW_EVENT_LOG, UA_VIEW_SYSLOG, UA_VIEW_TRAP_LOG,
			UA_XMPP_COMMANDS };
	...
	public void updateAccessRights(long rights) {
		setAccessRight(rights,
				UserAccessRights.SYSTEM_ACCESS_ALL_SCHEDULED_TASKS,
				UA_ALL_SCHEDULED_TASKS);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_CONFIGURE_TRAPS,
				UA_CONFIGURE_TRAPS);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_DELETE_ALARMS,
				UA_DELETE_ALARMS);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_EDIT_EVENT_DB,
				UA_EDIT_EVENT_DB);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_EPP, UA_EPP);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_MANAGE_ACTIONS,
				UA_MANAGE_ACTIONS);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_MANAGE_AGENT_CFG,
				UA_MANAGE_AGENT_CFG);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_MANAGE_IMAGE_LIB,
				UA_MANAGE_IMAGE_LIB);
		setAccessRight(rights,
				UserAccessRights.SYSTEM_ACCESS_MANAGE_MAPPING_TBLS,
				UA_MANAGE_MAPPING_TBLS);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_MANAGE_PACKAGES,
				UA_MANAGE_PACKAGES);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_MANAGE_SCRIPTS,
				UA_MANAGE_SCRIPTS);
		setAccessRight(rights,
				UserAccessRights.SYSTEM_ACCESS_MANAGE_SERVER_FILES,
				UA_MANAGE_SERVER_FILES);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_MANAGE_SESSIONS,
				UA_MANAGE_SESSIONS);
		setAccessRight(rights,
		...
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_MANAGE_TOOLS,
				UA_MANAGE_TOOLS);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_MANAGE_USERS,
				UA_MANAGE_USERS);
		setAccessRight(rights,
		...
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_REGISTER_AGENTS,
				UA_REGISTER_AGENTS);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_REPORTING_SERVER,
				UA_REPORTING_SERVER);
		setAccessRight(rights,
		...
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_SCHEDULE_SCRIPT,
				UA_SCHEDULE_SCRIPT);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_SEND_SMS,
				UA_SEND_SMS);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_SERVER_CONFIG,
				UA_SERVER_CONFIG);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_SERVER_CONSOLE,
				UA_SERVER_CONSOLE);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_UNLINK_ISSUES,
				UA_UNLINK_ISSUES);
		setAccessRight(rights,
				UserAccessRights.SYSTEM_ACCESS_USER_SCHEDULED_TASKS,
				UA_USER_SCHEDULED_TASKS);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_VIEW_AUDIT_LOG,
				UA_VIEW_AUDIT_LOG);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_VIEW_EVENT_DB,
				UA_VIEW_EVENT_DB);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_VIEW_EVENT_LOG,
				UA_VIEW_EVENT_LOG);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_VIEW_SYSLOG,
				UA_VIEW_SYSLOG);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_VIEW_TRAP_LOG,
				UA_VIEW_TRAP_LOG);
		setAccessRight(rights, UserAccessRights.SYSTEM_ACCESS_XMPP_COMMANDS,
				UA_XMPP_COMMANDS);
