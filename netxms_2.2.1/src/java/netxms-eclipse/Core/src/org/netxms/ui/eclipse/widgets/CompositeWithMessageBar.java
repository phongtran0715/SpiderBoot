...
/**
 * Composite capable of showing message bar on top of main content. Can be
 * either subclassed (then createContent method should be overriden) or used
 * directly (then getContent method should be used to obtain parent for
 * containing widgets).
 */
public class CompositeWithMessageBar extends Composite {
	...
	public CompositeWithMessageBar(Composite parent, int style) {
		...
		closeButton
				.setToolTipText(Messages.get().CompositeWithMessageBar_HideMessage);
		gd = new GridData();
