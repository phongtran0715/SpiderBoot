...
public class ScheduleSelector extends Composite {
	...
	public ScheduleSelector(Composite parent, int style) {
		...
		final SelectionListener listener = new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				execDateSelector
						.setEnabled(radioOneTimeSchedule.getSelection());
		...
		radioOneTimeSchedule
				.setText(Messages.get().ScheduleSelector_OneTimeExecution);
		...
		execDateSelector = (DateTimeSelector) WidgetHelper
				.createLabeledControl(scheduleGroup, SWT.NONE, factory,
	...
	public ScheduledTask getSchedule() {
		return new ScheduledTask(
				"Upload.File", radioCronSchedule.getSelection() ? textSchedule.getText() : "", "", "", execDateSelector.getValue(), 0, 0); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	}
