...
public class ConsoleSharedData {
	...
	private static Map<String, Object> consoleProperties = new HashMap<String, Object>(
			0);
	...
	public static void setServerTimeZone() {
		if (session != null) {
			...
			timeZone = TimeZone.getTimeZone(tz.replaceAll(
	 ...
	 *            name of the property
	 * @param defaultValue
	 *            default value if property does not exist or is not boolean
