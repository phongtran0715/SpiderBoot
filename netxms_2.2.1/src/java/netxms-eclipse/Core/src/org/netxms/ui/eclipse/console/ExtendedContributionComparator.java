...
/**
 * Extended contribution comparator. Takes priority encoded in contribution id
 * after # symbol into account. Contribution with lowest priority number wins.
 * 
 */
...
public class ExtendedContributionComparator extends ContributionComparator {
	 ...
	 * 
	 * @see
	 * org.eclipse.ui.model.ContributionComparator#compare(java.lang.Object,
	 * java.lang.Object)
	 */
	@Override
	...
	/**
	 * Extract page priority from page id. Expects page id to be in format
	 * id#priority. If priority is not given, -1 is returned.
	 * 
	 * @param node
	 *            contribution item
