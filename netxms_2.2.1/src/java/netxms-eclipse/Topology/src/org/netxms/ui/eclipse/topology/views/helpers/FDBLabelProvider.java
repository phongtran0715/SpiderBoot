 ...
 */
public class FDBLabelProvider extends LabelProvider implements
		ITableLabelProvider {
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case SwitchForwardingDatabaseView.COLUMN_TYPE:
			return (e.getType() == 3) ? Messages.get().FDBLabelProvider_Dynamic
					: ((e.getType() == 5) ? Messages.get().FDBLabelProvider_Static
							: Messages.get().FDBLabelProvider_Unknown);
		}
		return null;
	}
}
