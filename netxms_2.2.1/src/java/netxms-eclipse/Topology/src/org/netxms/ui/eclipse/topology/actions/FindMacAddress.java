...
public class FindMacAddress implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		...
		new ConsoleJob(String.format(Messages.get().FindMacAddress_JobTitle,
				macAddr), null, Activator.PLUGIN_ID, null) {
			@Override
			...
			protected String getErrorMessage() {
				return String.format(Messages.get().FindMacAddress_JobError,
						macAddr);
			}
		}.start();
	}
