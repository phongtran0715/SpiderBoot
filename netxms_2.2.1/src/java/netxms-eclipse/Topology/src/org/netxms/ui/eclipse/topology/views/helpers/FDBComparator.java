...
public class FDBComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object e1, Object e2) {
		...
		case SwitchForwardingDatabaseView.COLUMN_INTERFACE:
			result = fdb1.getInterfaceName().compareToIgnoreCase(
					fdb2.getInterfaceName());
			break;
		...
		case SwitchForwardingDatabaseView.COLUMN_NODE:
			String n1 = (fdb1.getNodeId() != 0) ? session.getObjectName(fdb1
					.getNodeId()) : ""; //$NON-NLS-1$
			String n2 = (fdb2.getNodeId() != 0) ? session.getObjectName(fdb2
					.getNodeId()) : ""; //$NON-NLS-1$
