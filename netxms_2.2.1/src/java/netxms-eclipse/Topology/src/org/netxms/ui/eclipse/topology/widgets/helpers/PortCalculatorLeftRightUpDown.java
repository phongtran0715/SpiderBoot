...
public class PortCalculatorLeftRightUpDown implements PortCalculator {
	 ...
	 * @param rowCount
	 */
	public PortCalculatorLeftRightUpDown(int nameSize, int portCount,
			int rowCount) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.netxms.ui.eclipse.topology.widgets.helpers.PortCalculator#
	 * calculateNextPos()
	 */
	@Override
	public Point calculateNextPos() {
		...
		int colCount = ((portCount % rowCount) != 0) ? (portCount / rowCount) + 1
				: (portCount / rowCount); // To maintain correct row count
