 ...
 implements SpiderAgentApp.AgentSideOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 8:  // SpiderAgentApp/AgentSide/getMonitorChannelId
       {
         int mappingId = in.read_long ();
         String $result = null;
       ...
       case 9:  // SpiderAgentApp/AgentSide/getClusterInfo
       {
         int clusterType = in.read_long ();
         int mappingId = in.read_long ();
         SpiderAgentApp.AgentSidePackage.ClusterInfo $result = null;
         $result = this.getClusterInfo (clusterType, mappingId);
         out = $rh.createReply();
         SpiderAgentApp.AgentSidePackage.ClusterInfoHelper.write (out, $result);
         break;
       }

       case 10:  // SpiderAgentApp/AgentSide/getAuthenInfo
       {
         int mappingId = in.read_long ();
         SpiderAgentApp.AgentSidePackage.AuthenInfo $result = null;
         $result = this.getAuthenInfo (mappingId);
         out = $rh.createReply();
         SpiderAgentApp.AgentSidePackage.AuthenInfoHelper.write (out, $result);
         break;
       }
