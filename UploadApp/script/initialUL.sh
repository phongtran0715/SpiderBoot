...
echo "# Folder luu video upload" >> ../$dirVideo/app.properties 
echo "VIDEO_FOLDER=video" >> ../$dirVideo/app.properties 
echo "# Privacy status upload" >> ../$dirVideo/app.properties 
echo "PRIVACY_STATUS=private" >> ../$dirVideo/app.properties 
