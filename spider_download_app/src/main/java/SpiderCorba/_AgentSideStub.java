...
public class _AgentSideStub extends org.omg.CORBA.portable.ObjectImpl implements SpiderCorba.AgentSide
{
  ...
  public SpiderCorba.AgentSidePackage.ClusterInfo getClusterInfo (int clusterType, int mappingId)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $out.write_long (mappingId);
                $in = _invoke ($out);
                SpiderCorba.AgentSidePackage.ClusterInfo $result = SpiderCorba.AgentSidePackage.ClusterInfoHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public SpiderCorba.AgentSidePackage.AuthenInfo getAuthenInfo (int mappingId)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $out.write_long (mappingId);
                $in = _invoke ($out);
                SpiderCorba.AgentSidePackage.AuthenInfo $result = SpiderCorba.AgentSidePackage.AuthenInfoHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
