...
public class _AgentSideStub extends org.omg.CORBA.portable.ObjectImpl implements SpiderCorba.AgentSide
{
  ...
  public long getLastSyncTime (int mappingId, int mappingType)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return getLastSyncTime (mappingId, mappingType        );
            } finally {
                _releaseReply ($in);
            }
  } // getLastSyncTime

  public void updateLastSyntime (int mappingId, int mappingType, long lastSyncTime)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                updateLastSyntime (mappingId, mappingType, lastSyncTime        );
            } finally {
                _releaseReply ($in);
            }
  } // updateLastSyntime
