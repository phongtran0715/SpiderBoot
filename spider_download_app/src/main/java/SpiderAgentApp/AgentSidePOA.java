 ...
 implements SpiderAgentApp.AgentSideOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       {
         int videoId = in.read_long ();
         int processStatus = in.read_long ();
         String videoLocation = in.read_string ();
         this.updateRenderedVideo (videoId, processStatus, videoLocation);
         out = $rh.createReply();
         break;
       }
       ...
       case 7:  // SpiderAgentApp/AgentSide/updateUploadedVideo
       {
         ...
         int processStatus = in.read_long ();
         String videoLocation = in.read_string ();
         this.updateUploadedVideo (videoId, processStatus, videoLocation);
         out = $rh.createReply();
         break;
       }
