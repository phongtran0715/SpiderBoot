...
public class _SpiderFootSideStub extends org.omg.CORBA.portable.ObjectImpl implements SpiderDownloadApp.SpiderFootSide
{
  ...
  public boolean createMappingChannel (int timerId, String cHomeId, String cMonitorId, int timerInterval)
  {
            ...
            try {
                ...
                $out.write_string (cHomeId);
                $out.write_string (cMonitorId);
                ...
                return createMappingChannel (timerId, cHomeId, cMonitorId, timerInterval        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public boolean modifyMappingChannel (int timerId, String cHomeId, String cMonitorId, int timerInterval, int synStatus)
  {
            ...
            try {
                ...
                return modifyMappingChannel (timerId, cHomeId, cMonitorId, timerInterval, synStatus        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public boolean deleteMappingChannel (int timerId)
  {
            ...
            try {
                ...
                return deleteMappingChannel (timerId        );
            } finally {
                _releaseReply ($in);
            }
