...
public class _RenderSideStub extends org.omg.CORBA.portable.ObjectImpl implements SpiderCorba.RenderSide
{
  ...
  public boolean createRenderJob (int jobId, SpiderCorba.SpiderDefinePackage.VideoInfo vInfo, SpiderCorba.RenderSidePackage.RenderConfig renderCfg)
  {
            ...
            try {
                ...
                SpiderCorba.RenderSidePackage.RenderConfigHelper.write ($out, renderCfg);
                $in = _invoke ($out);
                ...
                return createRenderJob (jobId, vInfo, renderCfg        );
            } finally {
                _releaseReply ($in);
            }
  } // createRenderJob
  ...
  public boolean deleteRenderJob (int jobId, String renderClusterId)
  {
            ...
            try {
                ...
                return deleteRenderJob (jobId, renderClusterId        );
            } finally {
                _releaseReply ($in);
            }
  } // deleteRenderJob
  ...
  public void deleteRenderdVideo (String renderClusterId, String vLocation)
  {
            ...
            try {
                ...
                deleteRenderdVideo (renderClusterId, vLocation        );
            } finally {
                _releaseReply ($in);
            }
  } // deleteRenderdVideo
